import pytest
from controllers.qa.support_data import WktDataItem
...
class TestWktDataItem:
    ...
    def test_fromLiteral(self, wkt_literal: str, expected: WktDataItem):
        # Act
        actual = WktDataItem.from_literal(wkt_literal)
