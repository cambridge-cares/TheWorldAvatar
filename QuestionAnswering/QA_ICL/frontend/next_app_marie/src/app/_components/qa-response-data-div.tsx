...
export interface QAResponseDataDivProps extends React.HTMLAttributes<HTMLDivElement> {
  qaResponseData: DataItem[]
}

export function QAResponseDataDiv({ qaResponseData, ...props }: QAResponseDataDivProps) {
  return (
    <div>
