...
objective.. z=e=sum(t,tp(t,'Pt')*tp(t,'Dt')-sum(i,(gp(i,'OM')+gp(i,'Fuel')+ fc(t,i)+ cp('tau')*gp(i,'Carb')*Q(t,i)*3600*24*350)-(tp(t,'Pt')-cp('delta'))*M(t)+((tp(t,'Pt')-cp('delta'))*X(t)))-sum(i,(a(i)-d(i))*dC(i)));
