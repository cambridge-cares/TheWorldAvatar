...
@WebServlet(urlPatterns = {"/BattRetrofit/startsimulationOPF" })
public class BattRetrofit extends JPSHttpServlet{
	...
	public List<String[]> generateInput(OntModel model, String iriofnetwork, String baseUrl, String modeltype) throws IOException {
		...
		//append the battery files after the generator
...
//		}
	...
	/*
	 * creates dummy value and has activePowerInjection for Battery in fourth position
	 */
