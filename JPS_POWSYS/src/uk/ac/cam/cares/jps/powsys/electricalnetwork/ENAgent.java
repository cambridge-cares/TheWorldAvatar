...
public class ENAgent extends JPSAgent{
	...
	public JSONObject startSimulation(String iriofnetwork, String baseUrl, String modeltype) throws IOException {
		...
		try {
			// TODO:
			// The file's name should be correspond to the names which generated by the query agent which written in the python code
			//also there are more function arguments that will feed into the pf analysis model
			// there will be a variable that contains all function configuration
...
//			try (BufferedWriter bw = new BufferedWriter(new FileWriter(tsvFileout))) {
	...
	public String runPythonScript(String script, String folder, String[] fileNames) throws Exception {
		//TODO: There need to validate the file names
			String result = "";
