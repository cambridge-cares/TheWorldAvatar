...
public static String getAllTriplesMoleculeProperty(String moleculeName) {
		...
		String query=
					...
					+"UNION"
					+"{"
					+"?uuid ontochem:hasInitialization ?mn2 ."
