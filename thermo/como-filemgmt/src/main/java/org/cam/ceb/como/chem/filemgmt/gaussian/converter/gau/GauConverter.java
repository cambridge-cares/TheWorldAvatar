...
import java.io.File;
import org.cam.ceb.como.chem.filemgmt.parser.ParserIntf;
import org.cam.ceb.como.chem.filemgmt.writer.WriterIntf;
 ...
 * @author pb556
 */
public class GauConverter implements GauConverterIntf {
    ...
    public void convert() throws Exception {
        ...
        if (this.comp.getCMLCompound().getId() != null) {
            this.writer.setPath(this.output.getAbsolutePath() + "\\" + this.comp.getCMLCompound().getId() + ".gau");
        } else {
            this.comp.getCMLCompound().setId(this.output.getAbsoluteFile().getName());
            this.writer.setPath(this.output.getAbsolutePath());
        }
