 ...
 * 
 * This class implements generating reactions for given target species (csv file) by using reference species (gaussian files). The code is build to work on HPC machine. It does not generate the same results on each run.  
 *  Input parameters are:
 *  - Gaussian files for 921 HCO species as a set of reference species.
 *  - Csv file that contains information about 921 HCO species. 
 *  - Number of runs: 1
 *  - Number of generated reactions: 1
 *  - Number of radicals: 0 
 *  
 *  The code is run on HPC machine.
 *  The code does not generate the same  outputs on each run. For example, the code does not read input files on the same order each time when we run the code. 
 *  
 */
...
//      String destRList = "C:\\Users\\pb556\\preprints\\methodology\\cnf_initial-submission\\rebuttal\\additional-calculations\\data\\reactions\\x-validation\\hco_isg\\";
        ...
        /**
         * @author NK510 (caresssd@hermes.cam.ac.uk)
         * Folder that contains Gaussian files of HCO species.
         */
      String srcCompoundsRef = "esc/g09/";
      
      /**
       * @author NK510 (caresssd@hermes.cam.ac.uk)
       * Csv file that contains data about target species.
       */
      String srcRefPool = "csv/ref-enthalpy_scaled_kJperMol.csv";
      
      /**
       * @author NK510 (caresssd@hermes.cam.ac.uk)
       * Destination folder that contains data generated by the code. 
       */
...
//      solver.setDirectory(new File("D:\\Data-Philip\\LeaveOneOutCrossValidation_temp\\"));
        ...
        /**
         * Folder that contains files used as input for GLPK solver. It also contains files generated by GLPK solver.
         */
