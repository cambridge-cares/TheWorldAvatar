...
//        String destRList = "C:\\Users\\pb556\\preprints\\methodology\\cnf_initial-submission\\rebuttal\\additional-calculations\\data\\reactions\\x-validation\\hco_isd\\";
...
//        String destRList = "C:\\Users\\NK\\Documents\\philipp\\180-pb556\\hco_isd\\";
        ...
        int[] ctrRes = new int[]{50}; // 1, 5, 50, //,2,3,4,5,6,7,8,9,7,5,8,7,9,10,2,3,4,10,35,50
        ...
        for (int z = 0; z < ctrRadicals.length; z++) {
            ...
            for (int i = 0; i < ctrRuns.length; i++) {
                for (int k = 0; k < ctrRes.length; k++) {
                    String config = "isd-int_runs" + ctrRuns[i] + "_res" + ctrRes[k] + "_radicals" + maxRadical + "_" + timeout + "s";
...
//                      PoolModificationCalculator poolModCalc = new PoolModificationCalculator(ctrRes[k], solver, new MPSFormat(false, new ISDReactionType()));
                        ...
                        try {
                            ...
                            for (Species s : results.keySet()) {
                            	...
                            	System.out.println("species as result: s.getRef(): " + s.getRef() + ", s.getHf(): " + s.getHf());
