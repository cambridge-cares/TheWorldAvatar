...
public class HCOISDReaction0RadicalTest {
	String folderName;
	...
	public void generateTestResults() throws Exception{
		...
		leaveOneOutCrossValidationAlgorithm.runGlobalCrossValidation(Folder.COMPOUNDS_REF_HCO.getFolderName(), Folder.REF_POOL_HCO.getFolderName(), Folder.REACTIONS_HCO_ISD.getFolderName()+folderName, Utils.ctrRuns, Utils.ctrRes, Utils.ctrRadicals_0, isdReactionTypePreProcessing, Folder.TEMP_FOLDER.getFolderName());
	}
