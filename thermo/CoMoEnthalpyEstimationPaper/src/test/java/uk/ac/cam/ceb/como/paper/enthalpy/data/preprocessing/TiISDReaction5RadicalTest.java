...
public class TiISDReaction5RadicalTest {
	...
	public void generateTestResults() throws Exception{
		...
		leaveOneOutCrossValidationAlgorithm.preProcessingAndInitialDataAnalysis(Folder.COMPOUNDS_REF_TI.getFolderName(), Folder.REF_POOL_TI.getFolderName(), Folder.REACTIONS_TI_ISD.getFolderName()+folderName, Utils.ctrRuns, Utils.ctrRes, Utils.ctrRadicals_5, isdReactionType);
	}
