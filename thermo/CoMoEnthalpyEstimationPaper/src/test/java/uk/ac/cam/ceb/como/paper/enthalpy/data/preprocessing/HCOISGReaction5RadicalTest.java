...
public class HCOISGReaction5RadicalTest {
	...
	public void generateTestResults() throws Exception{
		...
		leaveOneOutCrossValidationAlgorithm.preProcessingAndInitialDataAnalysis(Folder.COMPOUNDS_REF_HCO.getFolderName(), Folder.REF_POOL_HCO.getFolderName(), Folder.REACTIONS_HCO_ISG.getFolderName()+folderName, Utils.ctrRuns, Utils.ctrRes, Utils.ctrRadicals_5, isgReactionTypePreProcessing);
	}
