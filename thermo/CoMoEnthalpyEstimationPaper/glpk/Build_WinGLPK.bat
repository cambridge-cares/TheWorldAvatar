...
set glpkvers=4.58
set glpkjavavers=1.4.0
set glpkclivers=1.2.0
...
%gnuwin32%\wget http://download.sourceforge.net/project/glpk-java/glpk-java/glpk-java-%glpkjavavers%/libglpk-java-%glpkjavavers%.tar.gz
%gnuwin32%\wget http://download.sourceforge.net/project/glpk-cli/libglpk-cli/libglpk-cli-%glpkclivers%/libglpk-cli-%glpkclivers%.tar.gz
