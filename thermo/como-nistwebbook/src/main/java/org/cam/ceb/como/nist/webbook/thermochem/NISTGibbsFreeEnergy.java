...
/**
 * A model defined to represent the Gibbs Free Energy of the current</br> 
 * species as numerical values as opposed to string values.
 * 
 * @author msff2
 */
public class NISTGibbsFreeEnergy {
