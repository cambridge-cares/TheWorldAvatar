...
<xsl:transform version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" 
	...
	<xsl:template match="/">
		...
		<rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
			...
			<owl:Ontology rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#">
...
<!--   <owl:NamedIndividual rdf:about="http://como.cheng.cam.ac.uk/molhub/compchem/{$vdictRef_parent_no_namespace}_{$vmodule}_molecular_methоdology_{$id}">-->
            ...
            <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$folder_name}">
			<rdf:type rdf:resource="https://como.cheng.cam.ac.uk/kb/compchem.owl#G09"/>
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>

			<compchemkb:hasInitialization rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_initilization_module_{$id}"/>
				
		    <compchemkb:hasEnvironment rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_environment_module_{$id}"/>
		    ...
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_10.owl#species_10"/>
		    </xsl:if>

            <xsl:if test="$formula_name='H 1 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_6.owl#species_6"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_9.owl#species_9"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 O 1 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_7.owl#species_7"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 O 2 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_8.owl#species_8"/>
		    </xsl:if>

	        <xsl:if test="$formula_name='H 1 O 2 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_5.owl#species_5"/>
		    </xsl:if>		    
		    
		    <xsl:if test="$formula_name='N 2 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_4.owl#species_4"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='O 1 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_2.owl#species_2"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='O 2 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_3.owl#species_3"/>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 1 O 1 '">
		    <compchemkb:hasUniqueSpeciesIRI rdf:resource="http://www.theworldavatar.com/kb/species_1.owl#species_1"/>
		    </xsl:if>
		    
		    </owl:NamedIndividual>
		    
		    <xsl:if test="$formula_name='Ar 1 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_10.owl#species_10">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 1 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_6.owl#species_6">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_6.owl#species_9">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 O 1 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_7.owl#species_7">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 2 O 2 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_8.owl#species_8">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 1 O 2 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_5.owl#species_5">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='N 2 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_4.owl#species_4">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='O 1 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_2.owl#species_2">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='O 2 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_3.owl#species_3">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
		    
		    <xsl:if test="$formula_name='H 1 O 1 '">
		    <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/species_1.owl#species_1">
			<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
			</owl:NamedIndividual>
		    </xsl:if>
	...
	<xsl:template match="s:module/s:module/s:module/*[local-name() = 'module']">
		...
		<xsl:choose>
			...
			<owl:NamedIndividual
					rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_parent_no_namespace}_{$vmodule}_has_environment_module_{$id}">
			...
			<xsl:when test="$module_type='cc:initialization'">
				...
				<owl:NamedIndividual
					rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_parent_no_namespace}_{$vmodule}_has_initilization_module_{$id}">
					<rdf:type rdf:resource="https://como.cheng.cam.ac.uk/kb/compchem.owl#InitializationModule"/>
					
					<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>

					<gc:hasMoleculeProperty
						rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_property_{$id}"/>

				</owl:NamedIndividual>

				<rdf:Description
					rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_property_{$id}">
				...
				<owl:NamedIndividual
					rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_parent_no_namespace}_{$vmodule}_has_initilization_module_{$id}">
				<gc:hasParameter rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_level_of_theory_parameter_{$id}"/>	
				</owl:NamedIndividual>
			    <owl:NamedIndividual
					rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_level_of_theory_parameter_{$id}">
		        ...
		        <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_parent_no_namespace}_{$vmodule}_has_initilization_module_{$id}">
				<gc:hasParameter rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_basis_set_parameter_{$id}"/>	
				</owl:NamedIndividual>
					    
			    <owl:NamedIndividual
				rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_basis_set_parameter_{$id}">
				...
				<xsl:for-each select="s:molecule/s:atomArray/*[local-name() = 'atom']">
					...
					<owl:NamedIndividual
						...
						<gc:hasMolecule
							rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_{$velementType}{$atom_count}_{generate-id()}_{$id}"/>

					</owl:NamedIndividual>

                     
					<owl:NamedIndividual
						rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_{$velementType}{$atom_count}_{generate-id()}_{$id}">
						...
						<gc:hasAtom
							rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#atom_{$velementType}{$atom_count}_{generate-id()}_{$id}" />
					...
					<owl:NamedIndividual
						rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#atom_{$velementType}{$atom_count}_{generate-id()}_{$id}">
			...
			<xsl:when test="$module_type='cc:finalization'">
				...
				<xsl:for-each select="s:propertyList/*[local-name() = 'property']">
						...
						<xsl:for-each select="*[local-name()='array']">
							...
							<xsl:if test="$fdictRef_value='cc:frequencies'">
								...
								<owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$folder_name}">
									...
									<gc:isCalculationOn
										rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$vdictRef_value_no_namespace}_{generate-id()}_{$id}" />

								</owl:NamedIndividual>

								<owl:NamedIndividual
									rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$vdictRef_value_no_namespace}_{generate-id()}_{$id}">

									<rdf:type rdf:resource="http://purl.org/gc/VibrationalAnalysis"/>
									<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>

									<gc:hasResult
										rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$vdictRef_value_no_namespace}_{$fdictRef_value_no_namespace}_{generate-id()}_{$id}"/>

								</owl:NamedIndividual>

								<owl:NamedIndividual
									rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$vdictRef_value_no_namespace}_{$fdictRef_value_no_namespace}_{generate-id()}_{$id}">
					...
					<xsl:if test="@dictRef='cc:geometry_type'">
						...
						<owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$folder_name}">
							...
							<gc:isCalculationOn
								rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$gdictRef_value_no_namespace}_{generate-id()}_{$id}"/>
						</owl:NamedIndividual>

						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$gdictRef_value_no_namespace}_{generate-id()}_{$id}">
					...
					<xsl:if test="@dictRef='cc:rotational_symmetry'">
						...
						<xsl:for-each select="*[local-name()='scalar']">
							...
							<!--<owl:NamedIndividual rdf:about="http://como.cheng.cam.ac.uk/molhub/compchem/{$vdictRef_parent_of_parent_no_namespace}_{$vmodule}_molecular_methоdology_{$id}">-->
								...
								<gc:isCalculationOn
									rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$rsdictRef_value_no_namespace}_{generate-id()}_{$id}" />

							</owl:NamedIndividual>

							<owl:NamedIndividual
								rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$rsdictRef_value_no_namespace}_{generate-id()}_{$id}">
								<rdf:type
					...
					<xsl:if test="@dictRef='cc:rotational_constants'">
						...
						<xsl:for-each select="*[local-name()='array']">
                            ...
                            <owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$folder_name}">
								...
								<gc:isCalculationOn
									rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$rcdictRef_value_no_namespace}_{generate-id()}_{$id}"/>

							</owl:NamedIndividual>

							<owl:NamedIndividual
								rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_{$rcdictRef_value_no_namespace}_{generate-id()}_{$id}">
								<rdf:type
				...
				<xsl:if test="*[local-name()='molecule']">
					...
					<owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$folder_name}">
						...
						<gc:isCalculationOn
							rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_geometry_optimization_{generate-id()}_{$id}" />

					</owl:NamedIndividual>

					<owl:NamedIndividual
						rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_geometry_optimization_{generate-id()}_{$id}">
						<rdf:type rdf:resource="http://purl.org/gc/GeometryOptimization" />
						<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
						<gc:hasMolecule
							rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_{$id}" />
					</owl:NamedIndividual>
					...
					<owl:NamedIndividual
						rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_{$id}">
						<rdf:type rdf:resource="http://purl.org/gc/Molecule" />
						<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
					...
					<owl:NamedIndividual
						...
						<rdf:type rdf:resource="http://purl.org/gc/Molecule"/>
						<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing"/>
						<gc:hasFormalCharge resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_formal_charge_{$id}"/>							
					</owl:NamedIndividual>
					
					<owl:NamedIndividual rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_formal_charge_{$id}">
					...
					<xsl:for-each select="s:molecule/s:atomArray/*[local-name() = 'atom']">
						...
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_molecule_{$id}">
							<gc:hasAtom
								rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_atom_{$velementType}{$vid}_{generate-id()}_{$id}" />
						...
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_atom_{$velementType}{$vid}_{generate-id()}_{$id}">
							<rdf:type rdf:resource="http://purl.org/gc/Atom" />
							<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
							<gc:isElement
								rdf:resource="http://www.daml.org/2003/01/periodictable/PeriodicTable.owl#{$velementType}" />
							<gc:hasAtomCoordinateX
								rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_x3_{$velementType}{$vid}_{generate-id()}_{$id}" />
							<gc:hasAtomCoordinateY
								rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_y3_{$velementType}{$vid}_{generate-id()}_{$id}" />
							<gc:hasAtomCoordinateZ
								rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_z3_{$velementType}{$vid}_{generate-id()}_{$id}" />
							
							<gc:hasMass rdf:resource="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_mass_{$velementType}{$vid}_{generate-id()}_{$id}"/>
							
						</owl:NamedIndividual>
						
						
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_mass_{$velementType}{$vid}_{generate-id()}_{$id}">
						...
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_x3_{$velementType}{$vid}_{generate-id()}_{$id}">
							<rdf:type rdf:resource="http://purl.org/gc/FloatValue" />
							<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
							<gc:hasValue>
								<xsl:value-of select="$x3" />
						...
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_y3_{$velementType}{$vid}_{generate-id()}_{$id}">
							<rdf:type rdf:resource="http://purl.org/gc/FloatValue" />
							<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
							<gc:hasValue>
								<xsl:value-of select="$y3" />
						...
						<owl:NamedIndividual
							rdf:about="http://www.theworldavatar.com/kb/{$folder_name}/{$folder_name}.owl#{$vdictRef_no_namespace}_{$vmodule}_has_coordinate_z3_{$velementType}{$vid}_{generate-id()}_{$id}">
							<rdf:type rdf:resource="http://purl.org/gc/FloatValue" />
							<rdf:type rdf:resource="http://www.w3.org/2002/07/owl#Thing" />
							<gc:hasValue>
								<xsl:value-of select="$z3" />
