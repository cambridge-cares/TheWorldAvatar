...
import uk.ac.cam.ceb.como.thermo.partition_function.rotation.internal.hindered.tdppi.hs.TDPPIHSPartitionFunction;

/**
 *
 * @author pb556
 */
public class TDPPIHSThermoCalculator extends IRStatMechThermoCalculator {

    protected Logger logger = Logger.getLogger(getClass());

    public TDPPIHSThermoCalculator() {
        super();
    }
                    ...
                    if (getInternalRotorRule() == null || !hasInternalRotation()) {
                        ...
                        switch (getInternalRotorRule().getInternalRotorType()) {
                            ...
                            case CLASSICAL_LIMIT_HINDERED_ROTOR:
                                ...
                                TDPPIHSPartitionFunction q_hind = new TDPPIHSPartitionFunction((FourierSeries) getHindrancePotential(rBond), rot.getFrequency());
