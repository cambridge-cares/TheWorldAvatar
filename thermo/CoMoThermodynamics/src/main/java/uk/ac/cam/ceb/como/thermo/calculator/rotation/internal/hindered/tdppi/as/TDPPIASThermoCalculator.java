...
import uk.ac.cam.ceb.como.thermo.partition_function.rotation.internal.hindered.tdppi.as.TDPPIASPartitionFunction;
...
public class TDPPIASThermoCalculator extends IRStatMechThermoCalculator {
    ...
    public TDPPIASThermoCalculator() {
        super();
    }
                    ...
                    if (getInternalRotorRule() == null || !hasInternalRotation()) {
                        ...
                        switch (getInternalRotorRule().getInternalRotorType()) {
                            ...
                            case CLASSICAL_LIMIT_HINDERED_ROTOR:
                                ...
                                TDPPIASPartitionFunction q_hind = new TDPPIASPartitionFunction((FourierSeries) getHindrancePotential(rBond), rot.getFrequency());
