 ...
 * @author pb556
 */
public class C1DHRPartitionFunction extends PartitionFunction {
    ...
    public C1DHRPartitionFunction() {
        super();
    }

    public C1DHRPartitionFunction(Function approximation) {
        super();
    ...
    public PartitionValues getPartitionValues(double T) {
        ...
        try {
            ...
            double K = Math.sqrt(2.0 * Math.PI * PhysicalConstants.k_B * reducedMoment / (PhysicalConstants.h * PhysicalConstants.h));
