...
import uk.ac.cam.ceb.como.thermo.partition_function.rotation.internal.hindered.tdppi.hs.TDPPIHSIredPartitionFunction;

/**
 *
 * @author pb556
 */
public class TDPPIHSIredThermoCalculator extends IRStatMechThermoCalculator {

    protected Logger logger = Logger.getLogger(getClass());

    public TDPPIHSIredThermoCalculator() {
        super();
    }
                    ...
                    if (getInternalRotorRule() == null || !hasInternalRotation()) {
                        ...
                        switch (getInternalRotorRule().getInternalRotorType()) {
                            ...
                            case CLASSICAL_LIMIT_HINDERED_ROTOR:
                                ...
                                TDPPIHSIredPartitionFunction q_hind = new TDPPIHSIredPartitionFunction((FourierSeries) getHindrancePotential(rBond), rot.getFrequency());
