 ...
 * @author pb556
 */
public class TDPPIHSPartitionFunction extends PartitionFunction {
    ...
    public TDPPIHSPartitionFunction() {
        super();
    }

    public TDPPIHSPartitionFunction(FourierSeries approximation, double frequency) {
        super();
