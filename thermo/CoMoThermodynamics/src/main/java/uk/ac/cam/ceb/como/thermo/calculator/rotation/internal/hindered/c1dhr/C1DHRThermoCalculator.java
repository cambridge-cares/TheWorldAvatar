 ...
 * @author pb556
 */
public class C1DHRThermoCalculator extends IRStatMechThermoCalculator {

    protected Logger logger = Logger.getLogger(getClass());

    public C1DHRThermoCalculator() {
        super();
    }
                    ...
                    if (getInternalRotorRule() == null || !hasInternalRotation()) {
                        ...
                        switch (getInternalRotorRule().getInternalRotorType()) {
                            ...
                            case CLASSICAL_LIMIT_HINDERED_ROTOR:
                                ...
                                C1DHRPartitionFunction q_chind = new C1DHRPartitionFunction(getHindrancePotential(rBond));
