...
<head>
<link rel="icon" href="/static/group/favicon.ico" />
<link rel="stylesheet" type="text/css" href="/static/group/CoMoStyle.css">
<link rel="stylesheet" type="text/css" href="/static/group/CoMoIncludeStyle.css">
<link rel="stylesheet" type="text/css" href="/static/group/CoMoThemesStyle.css">
...
<div id="border">
    ...
    <div id="banner" class="default clearfix">
        <a href="/"><img id="banner-logo" src="/static/group/images/CoMo_Head_01.png" alt="Go to the CoMo homepage"/></a>
        <img id="banner-center" src="/static/group/images/CoMo_Head_02.png" alt="center banner image"/>
        <div id="banner-right">
            <div id="right-logo">
                <a href="http://www.cam.ac.uk/"><img src="/static/group/images/CoMo_Head_03.png" alt="University of Cambridge Logo"/></a>
                <a href="http://www.ceb.cam.ac.uk/"><img src="/static/group/images/CoMo_Head_04.png" alt="University of Cambridge Logo"/></a>
            </div>
        </div>
    </div>
...
<div id="leftnav" class="clearfix">
    ...
    <ul><li class="selcsm">OntoKin</li></ul>
</div>
...
<div class="Applications" id="subsubmenu">
    <ul class="clearfix">
        <li class="clearfix"><a class='selected'>Upload</a></li>
