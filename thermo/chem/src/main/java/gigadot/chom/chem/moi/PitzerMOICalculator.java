...
public class PitzerMOICalculator {
     ...
     * @return
     */
    public double getMOI(MOIApproxLevel level, Bond bond, List<Bond> allRotorBonds) {
        switch (level) {
            case TOP_MOI:
    ...
    public double getCouplingInternalRotationsMOI(Bond bond, List<Bond> allRotorBonds) {
