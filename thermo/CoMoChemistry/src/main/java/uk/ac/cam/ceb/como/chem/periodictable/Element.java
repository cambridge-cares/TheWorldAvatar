...
public class Element {
    ...
    public Element(String symbol, String name, int atomicNumber, int massNumber, double atomicWeight) {
        this.symbol = symbol.trim();
        this.name = name.trim();
        this.atomicNumber = atomicNumber;
        this.massNumber = massNumber;
    ...
    public Element(String symbol, String name, int atomicNumber, int massNumber, int period, int group, double atomicWeight) {
        this.symbol = symbol.trim();
        this.name = name.trim();
        this.atomicNumber = atomicNumber;
        this.massNumber = massNumber;
