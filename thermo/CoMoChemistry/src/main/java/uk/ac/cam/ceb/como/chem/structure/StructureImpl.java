...
public class StructureImpl implements Structure {
    ...
    public double getWeigth() {
        ...
        for (Atom atom : AtomList) {
            mol_weight += atom.getElement().getAtomicWeight();
        }
        return mol_weight;
    }
    ...
    public double[] getCentreOfMass() {
        ...
        for (Atom atom : AtomList) {
            ...
            CM[0] += e.getAtomicWeight() * atom.getX();
            CM[1] += e.getAtomicWeight() * atom.getY();
            CM[2] += e.getAtomicWeight() * atom.getZ();
        }
    ...
    public void calculateBonds() {
        CMLMolecule cmlMol = BasicCompoundConverter.convertToCMLMolecule(this);
