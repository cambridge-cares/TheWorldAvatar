...
public class StructuralCompoundComparison {
    ...
    public static boolean isEqual(Atom atom, CMLAtom cmlAtom) {
        return atom.getElement().getAtomicNumber() == cmlAtom.getChemicalElement().getAtomicNumber()
                //equal &= atom.getElement().getAtomicWeight() == cmlAtom.getChemicalElement().getAtomicWeight()
                && atom.getElement().getSymbol().equals(cmlAtom.getChemicalElement().getSymbol())
    ...
    public static boolean isEqual(Atom atom1, Atom atom2) {
        return atom1.getElement().getAtomicNumber() == atom2.getElement().getAtomicNumber()
                && atom1.getElement().getAtomicWeight() == atom2.getElement().getAtomicWeight()
                && atom1.getElement().getSymbol().equals(atom2.getElement().getSymbol())
