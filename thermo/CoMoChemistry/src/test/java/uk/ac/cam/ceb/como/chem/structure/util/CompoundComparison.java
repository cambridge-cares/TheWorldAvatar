...
public class CompoundComparison {
    ...
    public static boolean isCH4(Compound c) {
        ...
        for (int i = 0; i < c.getBondCount(); i++) {
            if ((c.getBond(i).getAtomA().getElement().getSymbol().equals("C") && c.getBond(i).getAtomB().getElement().getSymbol().equals("H") && c.getBond(i).getBondType() == BondType.SINGLE)
                    || (c.getBond(i).getAtomA().getElement().getSymbol().equals("H") && c.getBond(i).getAtomB().getElement().getSymbol().equals("C"))) {
                ctrCH++;
            } else {
                ctrOther++;
            }
        ...
        if (c.getVibrationCount() > 0) {
            isCH4 &= (c.getVibrationCount() == vibs.size());
            for (int i = 0; i < vibs.size(); i++) {
                isCH4 &= (vibs.contains(c.getVibration(i).getFrequency()));
            }
        }
    ...
    public static boolean isC2H4(Compound c) {
        ...
        for (int i = 0; i < c.getBondCount(); i++) {
            if ((c.getBond(i).getAtomA().getElement().getSymbol().equals("C") && c.getBond(i).getAtomB().getElement().getSymbol().equals("H") && c.getBond(i).getBondType() == BondType.SINGLE)
                    || (c.getBond(i).getAtomA().getElement().getSymbol().equals("H") && c.getBond(i).getAtomB().getElement().getSymbol().equals("C"))) {
                ctrCH++;
            } else if (c.getBond(i).getAtomA().getElement().getSymbol().equals("C") && c.getBond(i).getAtomB().getElement().getSymbol().equals("C") && c.getBond(i).getBondType() == BondType.DOUBLE) {
                ctrCC++;
            } else {
                ctrOther++;
            }
        ...
        if (c.getVibrationCount() > 0) {
            ...
            for (int i = 0; i < vibs.size(); i++) {
                isC2H4 &= (vibs.contains(c.getVibration(i).getFrequency()));
            }
        }
    ...
    public static boolean isC3H8(Compound c) {
        ...
        for (int i = 0; i < c.getBondCount(); i++) {
            if ((c.getBond(i).getAtomA().getElement().getSymbol().equals("C") && c.getBond(i).getAtomB().getElement().getSymbol().equals("H") && c.getBond(i).getBondType() == BondType.SINGLE)
                    || (c.getBond(i).getAtomA().getElement().getSymbol().equals("H") && c.getBond(i).getAtomB().getElement().getSymbol().equals("C"))) {
                ctrCH++;
            } else if (c.getBond(i).getAtomA().getElement().getSymbol().equals("C") && c.getBond(i).getAtomB().getElement().getSymbol().equals("C") && c.getBond(i).getBondType() == BondType.SINGLE) {
                ctrCC++;
            } else {
                ctrOther++;
            }
        ...
        if (c.getVibrationCount() > 0) {
            ...
            for (int i = 0; i < vibs.size(); i++) {
                isC3H8 &= (vibs.contains(c.getVibration(i).getFrequency()));
            }
        }
