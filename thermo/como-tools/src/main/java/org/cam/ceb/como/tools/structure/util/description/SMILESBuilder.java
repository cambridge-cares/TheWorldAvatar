 ...
 * @author pb556
 */
public class SMILESBuilder extends OBOutputBuilder {

    public SMILESBuilder() {
        super();
    }
    ...
    public String build(CMLMolecule mol) {
        ...
        try {
            ...
            try {
                ...
                output = new File(tempDir, "output.smi");
                String retVal = OpenBabelConverter.convert(CommandLine.parse("babel -imol " + input.getAbsolutePath() + " -osmi " + output.getAbsolutePath() + " -I --unique"), input, output, false, false);
