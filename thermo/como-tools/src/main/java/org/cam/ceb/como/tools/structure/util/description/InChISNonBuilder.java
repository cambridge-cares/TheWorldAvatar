 ...
 * @author pb556
 */
public class InChISNonBuilder extends OBOutputBuilder {
    
    public InChISNonBuilder() {
        super();
    }
    ...
    public String build(CMLMolecule mol) {
        ...
        try {
            ...
            try {
                ...
                return OpenBabelConverter.convert(CommandLine.parse("babel -imol " + input.getAbsolutePath() + " -oinchi " + output.getAbsolutePath() + " --DoNotAddH --SNon"), input, output, false, false);
