 ...
 *           &lt;element ref="{http://www.xml-cml.org/schema}atomicBasisFunction"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
public class BasisSet {
    ...
    protected List<AtomicBasisFunction> atomicBasisFunction;
    ...
    /**
     * Gets the value of the atomicBasisFunction property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the atomicBasisFunction property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getAtomicBasisFunction().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link AtomicBasisFunction }
     * 
     * 
     */
    public List<AtomicBasisFunction> getAtomicBasisFunction() {
        if (atomicBasisFunction == null) {
            atomicBasisFunction = new ArrayList<AtomicBasisFunction>();
        }
        return this.atomicBasisFunction;
    }
