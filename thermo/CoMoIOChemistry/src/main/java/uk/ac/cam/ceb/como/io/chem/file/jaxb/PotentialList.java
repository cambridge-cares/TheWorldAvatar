 ...
 *           &lt;element ref="{http://www.xml-cml.org/schema}potential"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlRootElement(name = "potentialList")
public class PotentialList {

    protected List<Potential> potential;
     ...
     * This is why there is not a <CODE>set</CODE> method for the potential property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPotential().add(newItem);
     * </pre>
     * 
     * 
     * <p>
    ...
    public List<Potential> getPotential() {
        if (potential == null) {
            potential = new ArrayList<Potential>();
        }
