 ...
 *         &lt;element ref="{http://www.xml-cml.org/schema}atomType" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
...
public class AtomTypeList {
     ...
     * 
     */
    public List<AtomType> getAtomType() {
        if (atomType == null) {
            atomType = new ArrayList<AtomType>();
        }
