 ...
 */
package uk.ac.cam.ceb.como.rotation.hindered.io.g09;
...
import uk.ac.cam.ceb.como.io.chem.file.parser.g09.GaussianHRParser;
 ...
 * @author pb556
 */
public class G09HRFileParserTest {

    @Test
    public void getInitMoleculeTest_0232() throws Exception {
        IRCompChemWrapper hrCCW = getCompChemWrapper(new File("test_data/ref/freq-hr-fine-species-0232-radical-0-restricted.g09"));
...
//        assert (modes.getForceConstantUnit().equals("nonSi:mDyne/A^-1"));
    ...
    protected IRCompChemWrapper getCompChemWrapper(File file) throws Exception {
        ...
        return new IRCompChemWrapper((CompChem) parser.get());
    }
}
