...
public class RemoveFlaggedReactionsTest {
    ...
    @Test
    public void checkRemovedFlaggedReactionsTest() throws FileNotFoundException, Exception {
        ...
        rListParser.set(new File("test_data/reactions/isd_marking25_10runs_pool230_sol.rct"));
        rListParser.parse();
        ReactionDataList rListSolData = (ReactionDataList) rListParser.get();
        
        rListParser.set(new File("test_data/reactions/isd_marking25_10runs_pool230_det.rct"));
        rListParser.parse();
    ...
    @Test
    public void removeFlaggedReactionsTest() throws FileNotFoundException, Exception, Exception {
