...
public class MeanReactionSelectorTest {
    ...
    @Test
    public void meanReactionSelectorTest() throws FileNotFoundException, Exception {        
        ...
        rListParser.set(new File("test_data/reactions/isd_marking25_10runs_pool230_det_589-34-4.rct"));
        rListParser.parse();
