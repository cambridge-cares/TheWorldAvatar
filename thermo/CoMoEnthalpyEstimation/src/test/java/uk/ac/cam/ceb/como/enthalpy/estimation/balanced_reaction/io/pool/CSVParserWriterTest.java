...
public class CSVParserWriterTest {
    ...
    @Test
    public void ISDAppendTest() throws Exception {
     ...
     @Test
    public void ISDWriteTest() throws Exception {
        File csv = new File("test_data/test_isdcsvwriter.csv");
        FileUtils.deleteQuietly(csv);
    ...
    @Test
    public void ISGWriteTest() throws Exception {
        File csv = new File("test_data/test_isdcsvwriter.csv");
        FileUtils.deleteQuietly(csv);
    ...
    @Test
    @Ignore
    public void ISGAppendTest() throws Exception {
        File csv = new File("test_data/test_isdcsvwriter.csv");
        FileUtils.deleteQuietly(csv);
    ...
    @Test
    public void refISDParserTest() throws FileNotFoundException, Exception {
    ...
    @Test
    public void refISGParserTest() throws FileNotFoundException, Exception {
        File csv = new File("test_data/csv/ref.csv");
        CSVParser parser = new SpeciesPoolParser(csv);
        parser.parse();
        assert (parser.getRefSpecies().size() == 8);
    ...
    @Test
    public void refMissingISDParserTest() throws FileNotFoundException, Exception {
    ...
    @Test
    public void refMissingISGParserTest() throws FileNotFoundException, Exception {
        File csv = new File("test_data/csv/ref_missing.csv");
        CSVParser parser = new SpeciesPoolParser(csv);
        parser.parse();
        assert (parser.getRefSpecies().size() == 6);
    ...
    @Test
    public void soiISDParserTest() throws FileNotFoundException, Exception {
    ...
    @Test
    public void soiISGParserTest() throws FileNotFoundException, Exception {
        File csv = new File("test_data/csv/soi.csv");
        CSVParser parser = new SpeciesPoolParser(csv);
        parser.parse();
        assert (parser.getRefSpecies().isEmpty());
    ...
    @Test
    public void mixISDParserTest() throws FileNotFoundException, Exception {
    ...
    @Test
    public void mixISGParserTest() throws FileNotFoundException, Exception {
        File csv = new File("test_data/csv/mix.csv");
        CSVParser parser = new SpeciesPoolParser(csv);
        parser.parse();
        assert (parser.getRefSpecies().size() == 8);
