...
if __name__ == "__main__":
    ...
    get_data("Template-Powerplant-MarginalSeller.xlsx", "Input-Template-Auto.csv", "2017", "03", "01", "2022", "04", "01", 2832) #Inclusive of start / end date (as with other similar scripts). 
