...
if __name__ == "__main__":
    ...
    get_data("Template-Powerplant-MarginalSeller.xlsx", "Input-Template-Auto.csv", "2022", "05", "19", "2022", "05", "20", 0) #Inclusive of start / end date (as with other similar scripts). 
