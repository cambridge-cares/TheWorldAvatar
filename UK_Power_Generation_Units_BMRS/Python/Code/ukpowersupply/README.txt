...
These (csv/excel) files may be found in the "\Dropbox (Cambridge CARES)\IRP3 CAPRICORN shared folder\_JPS Development\data\ukpowersupply" folder. There the names of the folders will match those found in this directory - containing the excel / csv files within. 
