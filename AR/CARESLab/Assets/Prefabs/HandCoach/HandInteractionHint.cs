...
namespace Microsoft.MixedReality.Toolkit.UI.HandCoach
{
    ...
    public class HandInteractionHint : MonoBehaviour
    {
        ...
        private bool IsHandTracked()
        {
            ...
            return aggregator.TryGetJoint(TrackedHandJoint.IndexTip, XRNode.LeftHand, out HandJointPose jointPose) || aggregator.TryGetJoint(TrackedHandJoint.IndexTip, XRNode.RightHand, out HandJointPose jointPose2);
        }
    }
}
