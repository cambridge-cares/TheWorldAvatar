...
if __name__ == "__main__":
	...
	f = open(folder + "/industrial.csv", 'ab')
	
	result = industrial(np.zeros(24), np.zeros(24), AirTemp, industry_below, industry_above,
	...
	pythonLogger.postInfoToLogServer('end of industrial.py')