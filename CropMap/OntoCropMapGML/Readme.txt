...
# Vocabulary creation    #
##########################
If you want to add a vocabulary to Blazegraph and build a war or jar file on your own, clone Java code from the URL https://github.com/blazegraph/database.git and put PolygonVocabulary.java under the path of "database\bigdata-core\bigdata-rdf\src\java\com\bigdata\rdf\vocab".
