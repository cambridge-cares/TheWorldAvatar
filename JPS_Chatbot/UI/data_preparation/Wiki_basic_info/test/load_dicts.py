...
with open('./WIKI_DICTS/SMILES_URI_DICT') as f:
    SMILES_URI_DICT = json.loads(f.read())
    f.close()

with open('./WIKI_DICTS/NAME_URI_DICT') as f:
    NAME_URI_DICT = json.loads(f.read())
    f.close()

with open('./WIKI_DICTS/FORMULA_URI_DICT') as f:
    FORMULA_URI_DICT = json.loads(f.read())
    f.close()

with open('./WIKI_DICTS/ATTRIBUTE_URI_DICT') as f:
    ATTRIBUTE_URI_DICT = json.loads(f.read())
    f.close()

with open('./WIKI_DICTS/CLASS_URI_DICT') as f:
