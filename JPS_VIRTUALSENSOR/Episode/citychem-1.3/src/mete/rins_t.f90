! <rins_t.f90 - A component of the City-scale
...
! Read heat diffusivites from file
          ...
          DO 100 IZ = 1,NZ
              CALL R3DFLD(INS_TUN,INS_TFM,IZ,TEXT1,TEXT2,      &
                         NX,NY,NZ,MX,MY,MZ,INS_T)
  100     CONTINUE
...
! Set homogeneous level midpoint heights
                  ...
                  CALL H3DFLD(INS_TFV,IZ,NX,NY,NZ,MX,MY,MZ,INS_T)
...
! Write message
 ...
 2000 format ('RINS_T: Read 3D Insitu Temperature .. for time ', &
         4I2.2)
 2010 format ('RINS_T: Homogeneous 3D Insitu temperature..... for time ', &
         4I2.2,' = ',99(F10.3,','))
 2020 format ('RINS_T: 3D Insitu temperature contains missing data!')

! End of subroutine RINS_T

      end subroutine rins_t
