! <opofil.f90 - A component of the City-scale
...
! The subroutine opens an output file in either binary or ASCII mode
...
! If error in open of file then stop
      ...
      IF (MESSFE) THEN
          WRITE (MESSUN,*) 'OPOFIL: Error in open of output file: ', &
                          (FN(I:I),I=1,INDEX(FN,' ') - 1)
          print *,'opofil error in FN UN:', FN, UN
      ENDIF
      CALL STOPIT('OPOFIL: Error in open of output file!')
