...
!CHECK
    !  if ((IX==10).and.(IY==15).and.(IZ==1)) then
    !    print *,'box70 X=15,Y=10 P(O3) P(HONO) L(NO2)', 2.* RC(4)*X(OD,2), DJ(17)*X(HONO,2), RC(12)*X(NO2,2)
    !  endif
...
! End of subroutine BoxChem70
      ...
      SUBROUTINE CalcRC70(M,H2O,O2,TEMP)
