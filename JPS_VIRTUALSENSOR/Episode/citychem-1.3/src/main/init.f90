...
!*****************************************************************************!
      ...
      subroutine init(mainfn)

!     The subroutine initializes the application and 
!     returns the main input file name.
! ----------------------------------------------------------------------------------
! Based on:
...
!       Get main input file from command line argument
 ...
 1000 format(A256)
 2000 format('Please give the name of the main input file: ')
