! <cphotrate.f90 - A component of the City-scale
...
!*****************************************************************************!
      ...
      SUBROUTINE cphotrate(phi,alon,day,SunHr,ZenAng,Cloudv)
...
! Cloud correction
      ...
      !print *,'emep45_new calcdj2',CLOUDV,CLOUDF,A(3),B(3),OptAM,FAC(3), DJ(3)

      RETURN



      end subroutine cphotrate
