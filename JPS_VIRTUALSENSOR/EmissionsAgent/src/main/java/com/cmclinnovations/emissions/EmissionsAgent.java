...
public class EmissionsAgent extends DerivationAgent {
        ...
        void addEmissionTriples(Chimney chimney, DerivationOutputs derivationOutputs, String shipIri) {
                ...
                String pm10Id = derivationOutputs.createNewEntityWithBaseUrl(QueryClient.PREFIX,
                                QueryClient.PM10);
                String pm25Id = derivationOutputs.createNewEntityWithBaseUrl(QueryClient.PREFIX,
                                QueryClient.PM25);
