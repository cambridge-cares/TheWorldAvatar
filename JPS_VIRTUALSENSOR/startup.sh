...
docker pull ghcr.io/cambridge-cares/dispersion-interactor:1.1.5-dev-aermod-agent-cleanup-SNAPSHOT
docker pull ghcr.io/cambridge-cares/aermod-agent:1.1.5-dev-aermod-agent-cleanup-SNAPSHOT
...
docker pull ghcr.io/cambridge-cares/emissions-agent:1.1.5-dev-aermod-agent-cleanup-SNAPSHOT
docker pull docker.cmclinnovations.com/ship-input-agent:1.1.5-dev-aermod-agent-cleanup-SNAPSHOT
