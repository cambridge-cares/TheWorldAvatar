...
public class QueryClient {
        ...
        public void updateEmissionsData(JSONArray pollutantSourceData) {
                ...
                for (int i = 0; i < pollutantSourceData.length(); i++) {
                        ...
                        modify.insert(iri(densityIRI).isA(DENSITY).andHas(HAS_NUMERICALVALUE, densityValue).andHas(
                                        HAS_UNIT,
                                        DENSITY_UNIT));
                        modify.insert(iri(massFlowIRI).isA(MASS_FLOW).andHas(HAS_NUMERICALVALUE, emissionValue).andHas(
                                        HAS_UNIT,
                                        MASS_FLOW_UNIT));
        ...
        public void updatePirmasensEmissions() {
                ...
                for (int i = 0; i < numberSources; i++) {
                        ...
                        modify.insert(iri(pm25DensityIRI).isA(DENSITY).andHas(HAS_NUMERICALVALUE, pm25DensityValue)
                                        .andHas(HAS_UNIT,
                                                        DENSITY_UNIT));
                        ...
                        modify.insert(iri(pm10DensityIRI).isA(DENSITY).andHas(HAS_NUMERICALVALUE, pm10DensityValue)
                                        .andHas(HAS_UNIT,
                                                        DENSITY_UNIT));
