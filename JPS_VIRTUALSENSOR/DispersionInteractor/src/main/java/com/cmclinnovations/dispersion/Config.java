...
public class Config {
    ...
    public static final String AERMOD_AGENT_URL = System.getenv("AERMOD_AGENT_URL").replace("${STACK_NAME}",
            STACK_NAME);
    public static final String WEATHER_AGENT_URL = System.getenv("WEATHER_AGENT_URL").replace("${STACK_NAME}",
            STACK_NAME);
    public static final String SHIP_INPUT_AGENT = System.getenv("SHIP_INPUT_AGENT").replace("${STACK_NAME}",
            STACK_NAME);
    ...
    public static final String VIRTUAL_SENSOR_AGENT_URL = System.getenv("VIRTUAL_SENSOR_AGENT_URL").replace(
    ...
    public static final String SCHEMA = System.getenv("SCHEMA") != null ? System.getenv("SCHEMA") : "ontop";
    public static final String ONTOP_CONTAINER_NAME = System.getenv("ONTOP_CONTAINER_NAME") != null ? System.getenv("ONTOP_CONTAINER_NAME") : "public";
