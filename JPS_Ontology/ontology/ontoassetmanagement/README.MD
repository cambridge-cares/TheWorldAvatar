...
<!-- markdown-link-check-disable -->| [p2p-doc](https://purl.org/p2p-o/document)                      | `https://purl.org/p2p-o/document#` |
...
| [p2p-item](https://purl.org/p2p-o/item)                      | `https://purl.org/p2p-o/item#` |<!-- markdown-link-check-enable -->
