...
class CrossGraphTrainer:
    def __init__(self, df, test_step=300, epoch_num=800, batch_size=4, learning_rate=1e-5, gamma=0.5,
    ...
    def save_model(self):
        model_path = os.path.join(self.dataset_path, 'cross_graph_model_new')
...
if __name__ == '__main__':
    ...
    df = pd.read_csv(os.path.join(dataset_path, 'xxx.tsv'), sep='\t', index_col=0)
