...
from Marie.EntityLinking.chemspot.locations import CHEMSPOT_DIR, PY4J_JAR_PATH, CHEMSPOT_JAR_PATH, JAVA_PATH,\
...
tagger = ChemSpotFactory.createChemSpot(DICT_ZIP_PATH, IDS_ZIP_PATH, MULTICLASS_BIN_PATH)
