...
# with open(os.path.join(DATA_DIR, "CrossGraph/wikidata_numerical/wikidata_single_numerical_hash_list.json"), 'w') as f:
#     f.write(json.dumps(numerical_hash_list))
#     f.close()

# with open(os.path.join(DATA_DIR, "CrossGraph/wikidata_numerical/wikidata_single_numerical_hash_dict.json"), 'w') as f:
