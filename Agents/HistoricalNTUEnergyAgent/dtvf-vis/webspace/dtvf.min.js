...
class MapHandler_Cesium extends MapHandler {
    ...
    addShowHeatmapButton(){

        const htmlOverlay = document.getElementById("getShowHeatmapButton");
        const scratch = new Cesium.Cartesian2();
        MapHandler.MAP.scene.preRender.addEventListener(function () {
          const position = Cesium.Cartesian3.fromDegrees(103.6902004506, 1.3488937558);
    ...
    addBuildingUsageButton(){
            ...
            const htmlOverlay = document.getElementById("getBuildingUsageButton");
            const scratch = new Cesium.Cartesian2();
            MapHandler.MAP.scene.preRender.addEventListener(function () {
