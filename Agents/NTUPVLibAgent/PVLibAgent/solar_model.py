...
class SolarModel:
    ...
    def __init__(self, model_type, iri, filepath, query_endpoint, update_endpoint):
        global latitude, longitude
        ...
        if latitude == '':
            try:
                latitude = QueryData.query_latitude(iri, query_endpoint, update_endpoint)
        ...
        if longitude == '':
            try:
                longitude = QueryData.query_longitude(iri, query_endpoint, update_endpoint)
            except Exception as ex:
