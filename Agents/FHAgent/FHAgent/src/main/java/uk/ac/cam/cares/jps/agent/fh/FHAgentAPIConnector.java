...
public class FHAgentAPIConnector {
     ...
     */
    public FHAgentAPIConnector(String username, String password, String path_url, String device_id, String keys) {
     ...
     */
    public FHAgentAPIConnector(String filepath) throws IOException {
