    ...
    <body onload="initialise()">
        <div id="preamble-summary">
            ...
            <div id="introduction">
                ...
                <p>
                    <%
                        out.print(request.getAttribute("test-description").toString());

                        Object queryFile = request.getAttribute("query-file");
                        if (queryFile != null) {
                            out.println("You can view the SPARQL query used for this type of test <span style='color: blue; cursor: pointer; font-decoration: underlined;' onclick='viewFile(\"" + queryFile.toString() + "\");'>here</span>.");
                        }
                    %>
                </p>
                <p>
