...
def pubchem_id_insert(typeIRI, type, uuid, item, prov_iri, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:Identifier . 
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:value "#value#"^^xsd:string .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:hasProvenance <http://www.theworldavatar.com/kb/ontospecies/Reference_#prov_uuid#> .    
...
def pubchem_synonym_insert(type, uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> skos:altLabel "#value#" .  
...
def pubchem_num_prop_insert(typeIRI, type, uuid, item, prov_iri, unit_iri, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:Property .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:value \'#value#\'^^xsd:float .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:unit <http://www.theworldavatar.com/kb/ontospecies/Unit_#unit_uuid#>  .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:hasProvenance <http://www.theworldavatar.com/kb/ontospecies/Reference_#prov_uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:dateOfAccess \'#dateofaccess#\'^^xsd:date .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:originalDataString \'#description#\'^^xsd:string .  
...
def pubchem_thermo_prop_insert(typeIRI, type, uuid, item, prov_iri, unit_iri, ref_state_uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:ThermoProperty .
    os:ThermoProperty rdfs:subClassOf os:Property .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:value \'#value#\'^^xsd:float .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:unit <http://www.theworldavatar.com/kb/ontospecies/Unit_#unit_uuid#>  .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:hasReferenceState <http://www.theworldavatar.com/kb/ontospecies/ReferenceState_#ref_state_uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:hasProvenance <http://www.theworldavatar.com/kb/ontospecies/Reference_#prov_uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:dateOfAccess \'#dateofaccess#\'^^xsd:date .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:originalDataString "#description#"^^xsd:string .   
...
def pubchem_string_prop_insert(typeIRI, type, uuid, item, prov_iri, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> rdf:type #TypeIRI# .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:Property .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:value \'#description#\'^^xsd:string .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:hasProvenance <http://www.theworldavatar.com/kb/ontospecies/Reference_#prov_uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:dateOfAccess \'#dateofaccess#\'^^xsd:date .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_#type#_#uuid#> os:originalDataString \'#description#\'^^xsd:string .  
    """.replace('#TypeIRI#', typeIRI).replace('#type#', type).replace('#uuid#', uuid).replace('#prov_uuid#', prov_iri).replace('#item#', str(item))
...
def pubchem_classification_insert(typeIRI, type, uuid, item, prov_iri, classification_uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:Classification .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid#> .   
...
def pubchem_hm_classification_insert(typeIRI, type, uuid, item, prov_iri, classification_uuid1, classification_uuid2, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid1#> rdf:type os:#key# .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid2#> rdf:type os:#key# .
    os:#key# rdfs:subClassOf os:Classification .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid1#> .   
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid1#> rdf:type <http://www.theworldavatar.com/kb/ontospecies/#key#_#classification_uuid2#> .  
...
def pubchem_use_insert(typeIRI, type, uuid, item, prov_iri, use_uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#use_uuid#> rdf:type os:#key# .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#use_uuid#> .   
...
def pubchem_group_insert(typeIRI, type, uuid, item, prov_iri, group_uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#group_uuid#> rdf:type os:#key# .
    <http://www.theworldavatar.com/kb/ontospecies/#type#_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#group_uuid#> .   
...
def pubchem_atom_insert(uuid, geometryIRI, prov_uuid, unit_uuid, data):
    ...
    for p_item in data.keys():
        text="""<http://www.theworldavatar.com/kb/ontospecies/Species_#uuid#> gc:hasAtom <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_Species_#uuid#> .
            <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_Species_#uuid#> rdf:type gc:Atom ;
                os:hasXCoordinate <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_XCoordinate_1_Species_#uuid#> ;
                os:hasYCoordinate <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_YCoordinate_1_Species_#uuid#> ;
                os:hasZCoordinate <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_ZCoordinate_1_Species_#uuid#> ;
                os:hasCanonicalOrder \'#id#\'^^xsd:integer ;
                gc:isElement <#element#> .
            <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_XCoordinate_1_Species_#uuid#> rdf:type os:XCoordinate ;
                os:value \'#x#\'^^xsd:float ;
                os:unit <http://www.theworldavatar.com/kb/ontospecies/Unit_#unit_uuid#> ;
                os:fromGeometry #GeometryIRI# .
            <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_YCoordinate_1_Species_#uuid#> rdf:type os:YCoordinate ;
                os:value \'#y#\'^^xsd:float ;
                os:unit <http://www.theworldavatar.com/kb/ontospecies/Unit_#unit_uuid#> ;
                os:fromGeometry #GeometryIRI# .
            <http://www.theworldavatar.com/kb/ontospecies/Atom_#id#_ZCoordinate_1_Species_#uuid#> rdf:type os:ZCoordinate ;
...
def pubchem_bond_insert(uuid, item, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/Species_#uuid#> rdf:type os:Species ;
    ...
    <http://www.theworldavatar.com/kb/ontospecies/Bond_#item#_Species_#uuid#> rdf:type os:AtomicBond ;
        ...
        os:definedBy <http://www.theworldavatar.com/kb/ontospecies/Atom_#id1#_Species_#uuid#> ;
        os:definedBy <http://www.theworldavatar.com/kb/ontospecies/Atom_#id2#_Species_#uuid#> .   
...
def pubchem_1DNMR_insert(uuid, i, prov_uuid, unit_uuid, solvent_uuid, it_uuid, data):
    if 'value' in data['frequency']:
        ...
        frequency = ''
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> rdf:type os:#key# .
        os:#key# rdfs:subClassOf os:1DNMRSpectra .
        os:1DNMRSpectra rdfs:subClassOf os:NMRSpectra .
        os:NMRSpectra rdfs:subClassOf os:SpectralInformation .
    <http://www.theworldavatar.com/kb/ontospecies/Species_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> os:hasFrequency <http://www.theworldavatar.com/kb/ontospecies/Frequency_#key#_#item#_Species_#uuid#> ;
        ...
        os:hasSpectraGraph <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> rdf:type os:SpectraGraph .
    <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> os:hasX1Axis \'Shifts [ppm]\' ;
        os:hasYAxis \'Intensity\' .
    <http://www.theworldavatar.com/kb/ontospecies/Frequency_#key#_#item#_Species#_#uuid#> os:value \'#frequency#\'^^xsd:float ;
        os:unit <http://www.theworldavatar.com/kb/ontospecies/Unit_#unit_uuid#> .
    #peaks#        
    ...
    for p_item in data['peaks'].get('x1'):
        ...
        k = k + 1
        text="""<http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> os:hasPeak <http://www.theworldavatar.com/kb/ontospecies/Peak_#p_item#_SpectraGraph_#key#_#item#_Species_#uuid#> .
            <http://www.theworldavatar.com/kb/ontospecies/Peak_#p_item#_SpectraGraph_#key#_#item#_Species_#uuid#> os:hasX1 \'#shift1#\'^^xsd:float ;
...
def pubchem_2DNMR_insert(uuid, i, prov_uuid, unit_uuid, solvent_uuid, it_uuid, data):
    if 'value' in data['frequency']:
        ...
        frequency = ''
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> rdf:type os:#key# .
        os:#key# rdfs:subClassOf os:2DNMRSpectra .
...
def pubchem_ms_insert(uuid, i, prov_uuid, im_uuid, it_uuid, data):
    insert_str = """<http://www.theworldavatar.com/kb/ontospecies/Species_#uuid#> rdf:type os:Species .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> rdf:type os:#key# .
        os:#key# rdfs:subClassOf os:MassSpectrometry .
        os:MassSpectrometry rdfs:subClassOf os:SpectralInformation .
    <http://www.theworldavatar.com/kb/ontospecies/Species_#uuid#> os:has#key# <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/#key#_#item#_Species_#uuid#> os:hasIonizationMode <http://www.theworldavatar.com/kb/ontospecies/IonizationMode_#im_uuid#> ;
        os:hasInstrumentType <http://www.theworldavatar.com/kb/ontospecies/InstrumentType_#it_uuid#>  ;
        os:hasProvenance <http://www.theworldavatar.com/kb/ontospecies/Reference_#prov_uuid#> ;
        os:hasSpectraGraph <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> .
    <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> rdf:type os:SpectraGraph .
    <http://www.theworldavatar.com/kb/ontospecies/SpectraGraph_#key#_#item#_Species_#uuid#> os:hasX1Axis \'m/z\' ;
        os:hasYAxis \'Intensity\' .
    #peaks#        
