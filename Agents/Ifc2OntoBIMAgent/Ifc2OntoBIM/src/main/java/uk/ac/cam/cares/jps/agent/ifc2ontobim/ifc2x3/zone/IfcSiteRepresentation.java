...
public class IfcSiteRepresentation extends IfcAbstractRepresentation {
     ...
     */
    public IfcSiteRepresentation(String iri, String name, String uid, Queue<String> latitude, Queue<String> longitude, String refElevation) {
        ...
        // Parse the ref elevation values
