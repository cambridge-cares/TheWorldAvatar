...
/**
 * A class representing the Column concept in OntoBuildingStructure.
 *
 * @author qhouyee
 */
public class Column extends IfcModelRepresentation {
    ...
    public void constructStatements(LinkedHashSet<Statement> statementSet) {
        ...
        StatementHandler.addStatement(statementSet, this.elementIRI, OntoBimConstant.RDF_TYPE, OntoBimConstant.BIM_COLUMN_CLASS);
