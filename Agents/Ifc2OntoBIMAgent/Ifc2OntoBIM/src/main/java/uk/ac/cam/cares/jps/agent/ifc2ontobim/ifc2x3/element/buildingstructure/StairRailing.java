...
/**
 * A class representing the Railing concept as part of stairs in OntoBuildingStructure.
 *
 * @author qhouyee
 */
public class StairRailing extends IfcModelRepresentation {
     ...
     */
    public StairRailing(String iri, String name, String uid, String placementIri, String stairIri, String geomRepIri) {
        super(iri, name, uid, placementIri);
        this.elementIRI = this.getPrefix() + OntoBimConstant.STAIR_RAILING_CLASS + OntoBimConstant.UNDERSCORE + UUID.randomUUID();
    ...
    public void constructStatements(LinkedHashSet<Statement> statementSet) {
        ...
        StatementHandler.addStatement(statementSet, this.elementIRI, OntoBimConstant.RDF_TYPE, OntoBimConstant.BIM_STAIR_RAILING_CLASS);
