...
class DoorTest {
    ...
    void testConstructor() {
        Door sample = new Door(testIri1, testName1, testUID1, testPlacementIri1, testHostZoneIRI, testAssemblyIRI, testGeomModelIRI);
        ...
        Door sample2 = new Door(testIri2, testName2, testUID2, testPlacementIri2, testHostZoneIRI, testAssemblyIRI, testGeomModelIRI);
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testBaseUri1 + "Door_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.theworldavatar.com/kg/ontobim/hasGeometricRepresentation, " + testGeomModelIRI);
        ...
        expected.add(testAssemblyIRI + ", http://www.theworldavatar.com/kg/ontobuildingstructure/consistsOf, " + testBaseUri1 + "Door_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        return expected;
    }
}