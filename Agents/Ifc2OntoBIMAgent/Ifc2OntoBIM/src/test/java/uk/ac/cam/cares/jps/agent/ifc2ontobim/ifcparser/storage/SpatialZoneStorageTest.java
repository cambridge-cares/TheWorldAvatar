...
class SpatialZoneStorageTest {
    ...
    void testAddAndGetSite() {
        // Create a new sample representation
        IfcSiteRepresentation sampleSite = new IfcSiteRepresentation(TEST_SITE_IRI, TEST_SITE_NAME, TEST_SITE_UID, TEST_ZONE_PLACEMENT_IRI, null, null, null, TEST_ELEV.toString());
        // Execute method
    ...
    void testAddAndGetBuilding() {
        ...
        IfcBuildingRepresentation sampleBuilding = new IfcBuildingRepresentation(TEST_BUILDING_IRI, TEST_BUILDING_NAME,
                TEST_BUILDING_UID, TEST_ZONE_PLACEMENT_IRI, null, TEST_SITE_IRI, TEST_ELEV.toString(), TEST_ELEV.toString());
        // Execute method
