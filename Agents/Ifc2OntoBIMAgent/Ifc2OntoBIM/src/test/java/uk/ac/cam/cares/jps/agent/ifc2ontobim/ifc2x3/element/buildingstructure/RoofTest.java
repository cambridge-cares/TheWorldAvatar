...
class RoofTest {
    ...
    private static final String testIri2 = testBaseUri2 + "IfcRoof_316122";
    ...
    void testConstructor() {
        Roof sample = new Roof(testIri1, testName1, testUID1, testPlacementIri1, testHostZoneIRI, testGeomModelIRI);
        ...
        Roof sample2 = new Roof(testIri2, testName2, testUID2, testPlacementIri2, testHostZoneIRI, testGeomModelIRI);
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostZoneIRI + ", https://w3id.org/bot#containsElement, " + testBaseUri1 + "Roof_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri1 + "Roof_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.w3.org/1999/02/22-rdf-syntax-ns#type, http://www.theworldavatar.com/kg/ontobuildingstructure/Roof");
        expected.add(testBaseUri1 + "Roof_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri1 + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
