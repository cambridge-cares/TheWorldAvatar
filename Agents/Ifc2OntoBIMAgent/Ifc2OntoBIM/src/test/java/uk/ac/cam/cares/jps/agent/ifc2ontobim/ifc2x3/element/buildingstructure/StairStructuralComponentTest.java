...
class StairStructuralComponentTest {
    ...
    private static final String testIri1 = testBaseUri1 + "StairStructuralComponent_1242";
    ...
    private static final String testIri2 = testBaseUri2 + "StairStructuralComponent_122";
    ...
    void testConstructor() {
        StairStructuralComponent sample = new StairStructuralComponent(testIri1, testName1, testUID1, testPlacementIri1, testHostStairIRI, testGeomModelIRI);
        ...
        StairStructuralComponent sample2 = new StairStructuralComponent(testIri2, testName2, testUID2, testPlacementIri2, testHostStairIRI, testGeomModelIRI);
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostStairIRI + ", http://www.theworldavatar.com/kg/ontobuildingstructure/consistsOf, " + testBaseUri1 + "StairStructuralComponent_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri1 + "StairStructuralComponent_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.w3.org/1999/02/22-rdf-syntax-ns#type, http://www.theworldavatar.com/kg/ontobuildingstructure/StairStructuralComponent");
        expected.add(testBaseUri1 + "StairStructuralComponent_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri1 + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
