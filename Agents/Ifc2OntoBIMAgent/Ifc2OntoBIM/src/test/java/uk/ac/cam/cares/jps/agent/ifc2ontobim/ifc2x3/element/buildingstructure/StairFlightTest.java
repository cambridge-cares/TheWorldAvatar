...
class StairFlightTest {
    ...
    private static final String testIri1 = testBaseUri + "StairFlight_1242";
    ...
    private static final String testIri2 = testBaseUri + "StairFlight_122";
    ...
    void testConstructor() {
        StairFlight sample = new StairFlight(testName1, testUID1, testPlacementIri1, testHostStairIRI, testGeomModelIRI,
        ...
        StairFlight sample2 = new StairFlight(testName2, testUID2, testPlacementIri2, testHostStairIRI, testGeomModelIRI,
                testNoOfRiser.toString(), testNoOfTread.toString(), testRiserHeight.toString(), testTreadLength.toString());
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostStairIRI + ", https://www.theworldavatar.com/kg/ontobuildingstructure/consistsOf, " + testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.w3.org/1999/02/22-rdf-syntax-ns#type, https://www.theworldavatar.com/kg/ontobuildingstructure/StairFlight");
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobuildingstructure/hasNumOfRiser, \"" + testNoOfRiser);
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobuildingstructure/hasNumOfTread, \"" + testNoOfTread);
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobuildingstructure/hasRiserHeight, \"" + testRiserHeight);
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobuildingstructure/hasTreadLength, \"" + testTreadLength);
        expected.add(testBaseUri + "StairFlight_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
