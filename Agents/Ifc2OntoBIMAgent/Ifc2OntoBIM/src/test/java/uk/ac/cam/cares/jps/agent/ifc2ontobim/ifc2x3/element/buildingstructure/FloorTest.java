...
class FloorTest {
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testBaseUri + "Floor_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, " + JunitTestUtils.RDF_TYPE + ", https://www.theworldavatar.com/kg/ontobuildingstructure/Floor");
