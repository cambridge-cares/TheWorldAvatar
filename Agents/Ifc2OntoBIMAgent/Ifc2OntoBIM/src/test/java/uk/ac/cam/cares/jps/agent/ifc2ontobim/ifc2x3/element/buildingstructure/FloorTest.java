...
class FloorTest {
    ...
    private static final String testIri2 = testBaseUri + "IfcSlab_316122";
    ...
    void testConstructor() {
        Floor sample = new Floor(testName1, testUID1, testPlacementIri1, testHostZoneIRI, testGeomModelIRI);
        ...
        Floor sample2 = new Floor(testName2, testUID2, testPlacementIri2, testHostZoneIRI, testGeomModelIRI);
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostZoneIRI + ", https://w3id.org/bot#containsElement, " + testBaseUri + "Floor_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri + "Floor_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.w3.org/1999/02/22-rdf-syntax-ns#type, https://www.theworldavatar.com/kg/ontobuildingstructure/Floor");
        expected.add(testBaseUri + "Floor_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
