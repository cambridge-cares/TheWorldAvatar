...
class StairLandingTest {
    ...
    private static final String testIri1 = testBaseUri + "Landing_1242";
    ...
    private static final String testIri2 = testBaseUri + "Landing_122";
    ...
    void testConstructor() {
        StairLanding sample = new StairLanding(testName1, testUID1, testPlacementIri1, testHostStairIRI, testGeomModelIRI);
        ...
        StairLanding sample2 = new StairLanding(testName2, testUID2, testPlacementIri2, testHostStairIRI, testGeomModelIRI);
        // Test that the sample fields are correct
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostStairIRI + ", https://www.theworldavatar.com/kg/ontobuildingstructure/consistsOf, " + testBaseUri + "Landing_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri + "Landing_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.w3.org/1999/02/22-rdf-syntax-ns#type, https://www.theworldavatar.com/kg/ontobuildingstructure/Landing");
        expected.add(testBaseUri + "Landing_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, https://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
