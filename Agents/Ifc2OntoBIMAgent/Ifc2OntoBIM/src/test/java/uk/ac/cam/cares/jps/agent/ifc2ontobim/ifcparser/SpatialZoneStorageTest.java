...
class SpatialZoneStorageTest {
    ...
    private static final String TEST_SITE_IRI = TEST_BASE_URI + "IfcSiteRepresentation_142";
    private static final String TEST_BUILDING_IRI = TEST_BASE_URI + "IfcBuildingRepresentation_214";
    private static final String TEST_STOREY_IRI = TEST_BASE_URI + "IfcStoreyRepresentation_315";
    private static final String TEST_ROOM_IRI = TEST_BASE_URI + "IfcRoomRepresentation_462";
    ...
    void testAddAndGetSite() {
        ...
        IfcSiteRepresentation sampleSite = new IfcSiteRepresentation(TEST_SITE_IRI, TEST_ELEV.toString());
        // Execute method
    ...
    void testAddAndGetBuilding() {
        // Create a new sample representation
        IfcBuildingRepresentation sampleBuilding = new IfcBuildingRepresentation(TEST_BUILDING_IRI, TEST_SITE_IRI, TEST_ELEV.toString(), TEST_ELEV.toString());
        // Execute method
    ...
    void testAddAndGetStorey() {
        // Create a new sample representation
        IfcStoreyRepresentation sampleStorey = new IfcStoreyRepresentation(TEST_STOREY_IRI, TEST_BUILDING_IRI, TEST_ELEV.toString());
        // Execute method
    ...
    void testAddAndGetRoom() {
        // Create a new sample representation
        IfcRoomRepresentation sampleRoom = new IfcRoomRepresentation(TEST_ROOM_IRI, TEST_STOREY_IRI);
        // Execute method
