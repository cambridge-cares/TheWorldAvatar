...
class IfcStoreyRepresentationTest {
    ...
    void testSuperConstructor() {
        // First constructor
        IfcStoreyRepresentation sample = new IfcStoreyRepresentation(testIri1, testRefElev1.toString());
        ...
        // Second constructor
        IfcStoreyRepresentation sample2 = new IfcStoreyRepresentation(testIri2, testRefElev1.toString());
        // Test that the sample fields are correct
    ...
    void testConstructorRefElevation() {
        IfcStoreyRepresentation sample1 = new IfcStoreyRepresentation(testIri1, testRefElev1.toString());
        IfcStoreyRepresentation sample2 = new IfcStoreyRepresentation(testIri1, testRefElevation1);
        IfcStoreyRepresentation sample3 = new IfcStoreyRepresentation(testIri1, testRefElev2.toString());
        IfcStoreyRepresentation sample4 = new IfcStoreyRepresentation(testIri1, testRefElevation2);
        // Test that the sample fields are correct
    ...
    void testConstructStatementsNoRefElev() {
        ...
        IfcStoreyRepresentation sample = new IfcStoreyRepresentation(testIri1, null);
        // Execute method
