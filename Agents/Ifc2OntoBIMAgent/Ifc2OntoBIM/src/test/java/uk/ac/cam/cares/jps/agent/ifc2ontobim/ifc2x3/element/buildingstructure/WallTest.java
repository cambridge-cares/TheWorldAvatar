...
class WallTest {
    ...
    private static final String testIri1 = testBaseUri1 + "IfcWall_16012";
    ...
    private static final String testIri2 = testBaseUri2 + "IfcWallStandardCase_515122";
    ...
    private List<String> genExpectedCommonStatements() {
        ...
        expected.add(testHostZoneIRI + ", https://w3id.org/bot#containsElement, " + testBaseUri1 + "Wall_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
        expected.add(testBaseUri1 + "Wall_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.w3.org/1999/02/22-rdf-syntax-ns#type, http://www.theworldavatar.com/kg/ontobuildingstructure/Wall");
        expected.add(testBaseUri1 + "Wall_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.theworldavatar.com/kg/ontobim/hasIfcRepresentation, " + testBaseUri1 + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}");
    ...
    private List<String> genExpectedOptionalStatements() {
        List<String> expected = new ArrayList<>();
        expected.add(testBaseUri1 + "IfcModelRepresentation_[0-9a-f]{8}-[0-9a-f]{4}-4[0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}, http://www.theworldavatar.com/kg/ontobim/hasGeometricRepresentation, " + testSecGeomModelIRI);
        return expected;
    }
}