...
public class ModelKineticsSRMMoo extends MoDSMarshaller implements IModel {
	private static Logger logger = LoggerFactory.getLogger(ModelKineticsSRMMoo.class);
	...
	public ModelKineticsSRMMoo(MoDSMooAgentProperty MoDSMooAgentProperty) {
...
//	 */
//	@Override
//	public List<String> formFiles(ExecutableModel exeModel) throws IOException, MoDSMooAgentException {
//		return null;
//	}
//	
	 ...
	 */
	@Override
	public List<String> createFolderInitial(List<String> processedActiveParam) throws IOException, MoDSMooAgentException {
	...
	public void setUpMoDS() throws IOException, MoDSMooAgentException {
		...
		model.put("args", MoDSMooAgentProperty.getKineticsFolderPath().concat(SPACE).concat(MoDSMooAgentProperty.getKineticsExecutableName()));
	 ...
	 * @throws MoDSMooAgentException
	 */
	private String copyMechanismFile(File copyOfMechanismFilePath, File mechanism) throws IOException, MoDSMooAgentException {
		// create the BufferedReader and BufferedWriter to read and write files
		BufferedReader br = null;
		BufferedWriter bw = null;
	 ...
	 * @throws MoDSMooAgentException
	 */
	private String createInputParamsFile(File inputParamsFilePath, File expData) throws IOException, MoDSMooAgentException {
