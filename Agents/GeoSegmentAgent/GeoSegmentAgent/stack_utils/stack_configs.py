...
def retrieve_settings():
    ...
    DB_QUERY_URL_STACK = pg_conf_query.getJdbcURL('geosegment')
    ...
    DB_UPDATE_URL_STACK = pg_conf_update.getJdbcURL('geosegment')
    ...
    QUERY_ENDPOINT_STACK = bg_conf.getUrl('geosegment')
    UPDATE_ENDPOINT_STACK = bg_conf.getUrl('geosegment')
