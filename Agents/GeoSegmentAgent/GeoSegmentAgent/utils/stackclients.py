...
from GeoSegmentAgent.errorhandling.exceptions import StackException
from .jpsSingletons import stackClientsGw, jpsBaseLibGW
...
class OntopClient(StackClient):
    ...
    @staticmethod
    def upload_ontop_mapping(ontop_file):
...
class PostGISClient:
    ...
    def __init__(self, dburl, dbuser, dbpassword,
                 database):
        self.dburl = dburl
        self.dbuser = dbuser
    ...
    def check_point_feature_exists(self, lat, lon, feature_type, table):
        """
...
class GdalClient(StackClient):
    ...
    def uploadGeoJSON(self, geojson_string, database, table):
        """
...
class GeoserverClient(StackClient):
    ...
    def create_postgis_layer(self, geoserver_workspace,
                                   geoserver_layer,
                                   postgis_database):
        """
