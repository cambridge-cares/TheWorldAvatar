...
class ExecutionAgent(DerivationAgent):
    def process_request_parameters(self, derivation_inputs: DerivationInputs, derivation_outputs: DerivationOutputs):
        ...
        list_rxn_exp_instance = self.sparql_client.getReactionExperiment(derivation_inputs.getIris(ONTORXN_REACTIONEXPERIMENT))
        ...
        g = self.sparql_client.collect_triples_for_equip_settings(list_equip_settings)
