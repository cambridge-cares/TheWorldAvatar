...
* Modify \JParkSimulator-git\Agents\MoDSMechCalibAgent\src\main\resources\modsmechcalib-agent.properties in the same way of modifying \MoDSMechCalibAgent.war\WEB-INF\classes\modsmechcalib-agent.properties while deploying from MoDSMechCalibAgent.war
...
* Build MoDSMechCalibAgent
   - Get into \JParkSimulator-git\Agents\MoDSMechCalibAgent directory from cmd
   - Run "mvn clean install -DskipTests"
