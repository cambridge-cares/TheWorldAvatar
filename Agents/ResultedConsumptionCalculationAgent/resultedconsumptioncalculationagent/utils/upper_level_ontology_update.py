...
def initialize_assumptions(sparql_client):
    ...
    boiler_efficiency_iri = get_boiler_efficiency_iri(assumption_iri)
    proportion_of_heating_iri = get_proportion_of_heating_iri(assumption_iri)
    uptake_iri = get_uptake_iri(assumption_iri)
...
def initialize_indecies(sparql_client):
    ...
    country_iri = check_country()
    # Initialize consumption profiles
    consumption_profile_iri, elec_profile_iri, gas_profile_iri = get_consumption_profile_iri(country_iri)
