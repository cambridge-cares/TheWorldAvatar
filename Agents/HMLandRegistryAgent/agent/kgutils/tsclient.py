...
class TSClient:
    ...
    def __init__(self, kg_client, timeclass=TIMECLASS, rdb_url=DB_URL, 
        ...
        try:
            ...
            logger.error("Unable to initialise TS Remote Store client: {}".format(ex))
        ...
        try:
            ...
            logger.error("Unable to initialise TS client: {}".format(ex))
    ...
    def create_timeseries(times: list, dataIRIs: list, values: list):
        ...
        try:
            ...
            logger.error("Unable to create timeseries: {}".format(ex))
