...
def gen_tilesets(asset_data: pd.DataFrame, building_data: list[str], root_content_parameters: Optional[List[str]] = []):
    ...
    bim_tileset = gen_root_content(asset_data, building_data, root_content_parameters)
