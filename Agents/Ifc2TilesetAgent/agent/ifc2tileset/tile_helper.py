...
def gen_solarpanel_tileset():
    ...
    """
    glb_filepath = Path("./data/glb/solarpanel.glb")
    bbox = get_bbox(glb_filepath) if glb_filepath.is_file() else properties.bbox_root
...
def gen_sewagenetwork_tileset():
    ...
    """
    glb_filepath = Path("./data/glb/sewagenetwork.glb")
    bbox = get_bbox(glb_filepath) if glb_filepath.is_file() else properties.bbox_root
