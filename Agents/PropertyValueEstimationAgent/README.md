...
LAYERNAME                     # Target layer name in Geoserver (for property values)
                              # NOTE: also name of virtual PostGIS/Geoserver table
GEOSERVER_WORKSPACE
