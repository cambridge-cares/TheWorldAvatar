...
@inputtasks_bp.route('/api/airqualityagent/instantiate/stations', methods=['GET'])
...
@inputtasks_bp.route('/api/airqualityagent/instantiate/readings', methods=['GET'])
...
@inputtasks_bp.route('/api/airqualityagent/update/timeseries', methods=['GET'])
...
@inputtasks_bp.route('/api/airqualityagent/update/all', methods=['GET'])
