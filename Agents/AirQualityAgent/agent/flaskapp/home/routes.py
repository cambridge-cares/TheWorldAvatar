...
@home_bp.route('/airqualityagent', methods=['GET'])
def default():
    ...
    msg += "&nbsp&nbsp /airqualityagent/instantiate/stations"
    msg += "<BR>"
    msg += "<BR>"
    ...
    msg += "&nbsp&nbsp /airqualityagent/instantiate/readings"
    msg += "<BR>"
    msg += "<BR>"
    msg += "Request to add latest time series readings for all instantiated time series (GET request):<BR>"
    msg += "&nbsp&nbsp /airqualityagent/update/timeseries"
    msg += "<BR>"
    msg += "<BR>"
    ...
    msg += "&nbsp&nbsp /airqualityagent/update/all"
    msg += "<BR>"
    msg += "<BR>"
    msg += "##### Miscellaneous Functionality #####<BR>"
    msg += "This functionality is primarily kept for reference as visualisation is now based on Geoserver/PostGIS"
    msg += "<BR>"
    msg += "<BR>"
    ...
    msg += "&nbsp&nbsp /airqualityagent/retrieve/all"
    return msg
