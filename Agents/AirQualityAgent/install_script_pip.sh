...
echo "-------------------------------------------------------"
echo "--  Python UK Air Quality agent installation script  --"
echo "-------------------------------------------------------"
echo ""
#
...
CREATE_VENV='n'
# Specify name of virtual environment
VENV_NAME='air_venv'
VENV_DIR=$SPATH
DEV_INSTALL=''
# Specify python project name (as in setup.py)
PROJ_NAME='airquality'
...
function create_env {
    ...
    echo
        ...
        # Potentially specify specific Python version to use
