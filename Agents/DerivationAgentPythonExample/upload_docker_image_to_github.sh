...
AGENT_NAME='derivation_agent_python_example'
...
usage() {
    ...
    echo ""
    echo "Example usage:"
    echo "./upload_docker_image_to_github.sh -v 1.0.0            - upload version 1.0.0"
    echo "./upload_docker_image_to_github.sh -v 1.0.0-SNAPSHOT   - upload version 1.0.0-SNAPSHOT"
    echo "==============================================================================================================="
...
bump_agent_docker_image_version_number() {
    ...
    sed -bi "s|image:.*|image: $IMAGE_TAG|" $SPATH/docker-compose.github.yml
...
build_agent_docker_image() {
    ...
    echo "-------------------------------------------------------------------------"
    echo ; echo
    docker-compose -f $SPATH/docker-compose.github.yml build
