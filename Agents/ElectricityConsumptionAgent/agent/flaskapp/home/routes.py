...
def default():
    ...
    msg += " ---------------------- Data Download ------------------------------------"
    msg += "<BR>"
    msg += "Request to download xslx file of UK subregional (LSOA) Electricity Consumption/meter data:<BR>"
    msg += "&nbsp&nbsp /api/electricityconsumptionagent/download/electricity"
    msg += "<BR>"
    msg += "<BR>"
    msg += "Request to download xslx file of UK subregional (LSOA) Gas Consumption/meter/nonmeter data:<BR>"
    msg += "&nbsp&nbsp /api/electricityconsumptionagent/download/gas"
    msg += "<BR>"
    msg += "<BR>"
    msg += "Request to download xslx file of UK subregional (LSOA) fuel poverty data:<BR>"
    msg += "&nbsp&nbsp /api/electricityconsumptionagent/download/fuelpoverty"
    msg += "<BR>"
    msg += "<BR>"
    msg += "Request to download nc file of hadUK climate data in 1km grid:<BR>"
