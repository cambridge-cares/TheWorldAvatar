...
public interface IRepositoryManager {
	...
	public List<String> queryRepositoryExperimentalData(String serverURL, String repositoryID, String queryString) throws OntoException, MoDSSensAnaAgentException;
	public List<List<String>> queryRepository(String serverURL, String repositoryID, String queryString) throws MoDSSensAnaAgentException;
