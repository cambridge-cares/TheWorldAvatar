...
class TSPropertiesHandler {
     ...
     */
    protected TSPropertiesHandler(Map<String, List<?>> readings, String timeHeader) throws IOException {
        if (!readings.isEmpty()) {
            ...
            this.readingsKey.remove(timeHeader);
        } else {
        ...
        try (InputStream input = new FileInputStream(this.propertiesFile)) {
            ...
            if (checkMissingHeaders(prop)) {
                ...
                for (Map.Entry<Object, Object> entry : prop.entrySet()) {
                    ...
                    if (value.isEmpty()) {
                        value = generateIRI(HistoricalPumpDataInstantiationAgent.iriPrefix, key);
    ...
    private void setIRIMappings(Properties prop) {
        ...
        for (String header : this.readingsKey) {
            ...
            String value = generateIRI(HistoricalPumpDataInstantiationAgent.iriPrefix, header);
