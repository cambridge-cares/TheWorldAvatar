...
def convert_to_tensor(input, monthly_ref = None, LSOA_index_id = None, year:str ='2019'):
    '''
...
def call_pickle(pathname):
  ...
  '''
    try:
        ...
        raise KeyError("filepath can not be read -- check if the file exist") from ex
...
def read_from_excel_elec(year:str = '2019'):
    ...
    data = pd.read_excel('./Data/source_data/LSOA_domestic_elec_2010-21.xlsx', sheet_name=year, skiprows=4)
...
def read_from_excel_gas(year:str = '2019'):
    ...
    data = pd.read_excel('./Data/source_data/LSOA_domestic_gas_2010-21.xlsx', sheet_name=year, skiprows=4)
    LSOA_codes = data["LSOA code"].values
    met_num = data["Number\nof meters\n"].values
    consump = data["Total \nconsumption\n(kWh)"].values
...
def properties_to_csv():
    ...
    def temperature_to_csv(df):
        ...
        df_temp_max.to_csv('./Data/properties_csv/2019/Temperature_max.csv', index=False)
        df_temp_mean.to_csv('./Data/properties_csv/2019/Temperature_mean.csv', index=False)
        df_temp_min.to_csv('./Data/properties_csv/2019/Temperature_min.csv', index=False)
    ...
    def COP_to_csv():
        ...
        def COP_calculation(temp, hp_efficiency:float = 0.35, T_H: float = 45 +273.15):
            ...
            return COP
        try:
            df_temp_max = pd.read_csv('./Data/properties_csv/2019/Temperature_max.csv')
            df_temp_mean = pd.read_csv('./Data/properties_csv/2019/Temperature_mean.csv')
            df_temp_min = pd.read_csv('./Data/properties_csv/2019/Temperature_min.csv')
        except:
        ...
        df_cop_max.to_csv('./Data/properties_csv/2019/COP_max.csv', index=False)
        df_cop_mean.to_csv('./Data/properties_csv/2019/COP_mean.csv', index=False)
        df_cop_min.to_csv('./Data/properties_csv/2019/COP_min.csv', index=False)
