...
ONTOHEATNETWORK = "http://www.theworldavatar.com/kg/ontoheatnetwork/"

RDF_TYPE = RDF + "type"
IS_A = RDFS + "subClassOf"

ONTOCAPE_COUNTRY = ONTOCAPE + "Country"
ONTOCAPE_UTILITYCOST = ONTOCAPE + "UtilityCosts"
ONTOCAPE_HASUTILITYCOST = ONTOCAPE + "hasUtilityCosts"
ONTOCAPE_FUELCOSTS = ONTOCAPE + "FuelCosts"
ONTOCAPE_ELECTRICITYCOSTS = ONTOCAPE + "ElectricityCosts"
...
OFP_HOUSHOLD = OFP + "Household"
OFP_HASHOUSEHOLD = OFP + "hasHouseholds"
OFP_NUM_HOUSEHOLD = OFP + "numberofhouseholds"
OFP_FUELPOOR_HOUSEHOLD = OFP + "fuelpoorhouseholds"

ONTOHEATNETWORK_UNITRATE = ONTOHEATNETWORK + "UnitRate"
ONTOHEATNETWORK_FUELUNITCOST = ONTOHEATNETWORK + "FuelUnitCost"
ONTOHEATNETWORK_GASUNITCOST = ONTOHEATNETWORK + "GasUnitCost"
ONTOHEATNETWORK_HASUNITRATE = ONTOHEATNETWORK + "hasUnitRate"
...
REGION_MIN_FP = REGION + "MinimalFuelPoverty"
REGION_MAX_FP = REGION + "MaximalFuelPoverty"
REGION_ELECTRICITYUNITCOST = REGION + "ElectricityUnitCost"
REGION_GASCOSTS = REGION + "GasCosts"
REGION_INEQUALITYINDEX = REGION + "InequalityIndex"
...
REGION_HASSTATUS = REGION + "hasStatus"
REGION_HAS_INEQUALITY_INDEX = REGION + "hasInequalityIndex"