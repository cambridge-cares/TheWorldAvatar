...
# override the suzuki_step2_goal_request with cycleAllowance = 2, deadline to be 2 hrs from now
_sample_goal_request = copy.deepcopy(cf.suzuki_step2_goal_request)
...
@pytest.mark.parametrize(
    ...
    [
        (
            cf.TEST_TRIPLES_SUZUKI_STEP2_DIR,
            ...
            cf.IRIs.HPLC_METHOD_SUZUKI_STEP2.value,
        ),
    ],
)
