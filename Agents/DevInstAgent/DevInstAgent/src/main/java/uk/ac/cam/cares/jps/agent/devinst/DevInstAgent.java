...
public class DevInstAgent{
     ...
     */
    public DevInstAgent(String propertiesFile) throws IOException {
    ...
    private void readMappings(String mappingFolder) throws IOException {
        ...
        // Create a mapper for each file
            ...
            for (File mappingFile: mappingFiles) {
                JSONKeyToIRIMapper mapper = new JSONKeyToIRIMapper(DevInstAgent.generatedIRIPrefix, mappingFile.getAbsolutePath());
                mappings.add(mapper);
    ...
    private List<TimeSeries<OffsetDateTime>> convertReadingsToTimeSeries(Map<String, List<?>> RFIDVariableReadings,
        ...
        List<OffsetDateTime> allTimestamps = TimestampReadings.get(DevInstAgent.timestampKey).stream()
    ...
    private OffsetDateTime convertStringToOffsetDateTime(String timestamp) {
        ...
        return OffsetDateTime.of(localTime, DevInstAgent.ZONE_OFFSET);
    }
