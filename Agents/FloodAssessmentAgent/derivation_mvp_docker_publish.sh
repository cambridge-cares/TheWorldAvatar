...
AGENT_NAME='floodassessment_agent_deriv_mvp'
CARES_GITHUB='ghcr.io/cambridge-cares/'
DOCKER_COMPOSE_FILE='docker-compose-derivation-mvp.yml'
STEP_NR=1
NEXT_VERSION=''
IMAGE_TAG=''
...
usage() {
    ...
    echo ""
    echo "Example usage:"
    echo "./derivation_mvp_docker_publish.sh -v 1.0.0            - upload version 1.0.0"
    echo "./derivation_mvp_docker_publish.sh -v 1.0.0-SNAPSHOT   - upload version 1.0.0-SNAPSHOT"
    echo "==============================================================================================================="
