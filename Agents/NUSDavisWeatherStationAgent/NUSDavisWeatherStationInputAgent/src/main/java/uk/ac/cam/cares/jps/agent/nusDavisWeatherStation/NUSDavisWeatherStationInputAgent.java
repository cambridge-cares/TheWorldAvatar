 ...
 * @author  GMMajal*/
public class NUSDavisWeatherStationInputAgent {
    ...
    public NUSDavisWeatherStationInputAgent(String propertiesFile) throws IOException {
    ...
    private void readMappings(String mappingFolder) throws IOException {
        ...
        // Create a mapper for each file
            ...
            for (File mappingFile: mappingFiles) {
                JSONKeyToIRIMapper mapper = new JSONKeyToIRIMapper(NUSDavisWeatherStationInputAgent.generatedIRIPrefix, mappingFile.getAbsolutePath());
                mappings.add(mapper);
                    ...
                    if (!key.contains("temp_extra_1") || !key.contains("temp_extra_2") || !key.contains("temp_extra_3") || !key.contains("temp_extra_4")
                        ...
                        if (value == JSONObject.NULL) {
                            ...
                            if (key.contains("temp_in") || key.contains("temp_out") || key.contains("dew_point") || key.contains("heat_index") || key.contains("wind_chill")) {
                                ...
                                Double wind_sp = (Integer)value * 1.609344;
    ...
    private List<TimeSeries<OffsetDateTime>> convertReadingsToTimeSeries(Map<String, List<?>> weatherReadings)
        ...
        List<OffsetDateTime> weatherTimestamps = weatherReadings.get(NUSDavisWeatherStationInputAgent.timestampKey).stream()
    ...
    private OffsetDateTime convertStringToOffsetDateTime(String timestamp) {
        ...
        return OffsetDateTime.of(localTime, NUSDavisWeatherStationInputAgent.ZONE_OFFSET);
    }
