...
# Build
WORKDIR /root/NUSDavisWeatherStationInputAgent
...
ENV NUSDavisWeatherStation_AGENTPROPERTIES="/root/agent.properties"

# Copy in the properties file
COPY ./config/api.properties /root/api.properties

# Set the required environment variable
ENV NUSDavisWeatherStation_APIPROPERTIES="/root/api.properties"

# Copy in the properties file
COPY ./config/client.properties /root/client.properties

# Set the required environment variable
ENV NUSDavisWeatherStation_CLIENTPROPERTIES="/root/client.properties"
...
COPY --from=builder /root/NUSDavisWeatherStationInputAgent/output/nusdavisweatherstation-agent##1.0.0.war $CATALINA_HOME/webapps/
