...
auth = 'bWg4MDdAY2FtLmFjLnVrOjA4ZDYyZDk3YWRkYmZkYTNjOWZmNGI1MzczYTM5ZmNlMmE5YmE0NTQ='

# Example postcode
postcode = 'PE302QW'

# Specify API endpoints
url_epc_base = 'https://epc.opendatacommunities.org/api/v1/display/search?postcode='
url_rec_base = 'https://epc.opendatacommunities.org/api/v1/display/recommendations/'
...
epc_data.to_csv('./data/dec_summary.csv')
...
with open('./data/dec_recommendations.json', "w") as write_file:
