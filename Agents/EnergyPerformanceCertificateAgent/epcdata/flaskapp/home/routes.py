...
def default():
    ...
    msg += "<BR>"
    msg += "<BR>"
    msg += "Requests which require prior building instance matching using the Building Matching Agent"
    msg += "<BR>"
    msg += "<BR>"
    msg += "Request to instantiate (OntoCityGml) building elevation according to OntoBuiltEnv:<BR>"
    msg += "&nbsp&nbsp [GET request]   /api/epcagent/addElevation"
    msg += "<BR>"
    msg += "<BR>"
    msg += "<BR>"
    msg += "<BR>"
