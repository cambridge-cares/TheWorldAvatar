...
Afterwards, run the [upper_level_ontology_update.py](./utiliycostcalculationagent/upper_level_ontology_update.py), simply run this command in the powershell terminal:
...
<!-- Links -->
[markup.py]:./utiliycostcalculationagent/markup.py
