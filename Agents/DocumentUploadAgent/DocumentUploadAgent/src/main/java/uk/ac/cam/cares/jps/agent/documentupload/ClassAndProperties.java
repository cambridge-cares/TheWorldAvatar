...
public class ClassAndProperties {
    ...
    public static final String P_FOAF = "http://xmlns.com/foaf/0.1/";
    ...
    public static final Prefix Pref_FOAF = SparqlBuilder.prefix("foaf", iri(P_TIME));
    ...
    public static final Iri hasDataSheet = Pref_ASSET.iri("hasDataSheet");
    ...
    public static final String DocumentString = P_FOAF + "Document";
