 ...
 */
@Configuration
@PropertySource("classpath:automechcalib-agent.properties")
public class AutoMechCalibAgentProperty {
	...
	@Value("${sensana.agent.http.request.first.part}")
	private String sensAnaAgentHttpRequestFirstPart;
	
	@Value("${mechcalib.agent.http.request.first.part}")
	private String mechCalibAgentHttpRequestFirstPart;
	...
	public String getSensAnaAgentHttpRequestFirstPart() {
		return sensAnaAgentHttpRequestFirstPart;
	}

	public String getMechCalibAgentHttpRequestFirstPart() {
		return mechCalibAgentHttpRequestFirstPart;
	}
