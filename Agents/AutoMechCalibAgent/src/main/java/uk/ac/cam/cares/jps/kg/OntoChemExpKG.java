...
public class OntoChemExpKG extends RepositoryManager {
	...
	public DataTable formatFlameSpeedExpDataTable(String experimentIRI) throws AutoMechCalibAgentException {
		// TODO
	...
	public DataTable formatExperimentDataTable(String experimentIRI) throws AutoMechCalibAgentException {
		List<String> columnTitles = new ArrayList<String>();
		List<List<String>> experimentData = new ArrayList<List<String>>();
	...
	public List<List<String>> queryConcentration(String experimentIRI) throws AutoMechCalibAgentException {
	...
	public List<List<String>> queryEquivalenceRatio(String experimentIRI) throws AutoMechCalibAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
	...
	public List<List<String>> queryExperimentData(String experimentIRI) throws AutoMechCalibAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
	...
	public List<List<String>> queryFlameSpeedExpData(String experimentIRI) throws AutoMechCalibAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
