...
public class ModelCanteraLFS extends MoDSMarshaller implements IModel {
	...
	private String createActiveParametersFile(File activeParameterBaseMechanismFilePath, File mech) throws IOException, AutoMechCalibAgentException {
	...
	private String createPassiveParametersAndOutputsFile(File passiveParametersAndOutputsFilePath, 
			File expData, List<String> caseNames) throws IOException, AutoMechCalibAgentException {
		BufferedReader br = null;
		BufferedWriter bw = null;
	...
	private List<String> generateCanteraMechanismFile(File copyOfMechanismFilePath, File elementData, File mechanism) throws IOException, AutoMechCalibAgentException {
		// create the BufferedReader and BufferedWriter to read and write files
		BufferedReader br = null;
		BufferedWriter bw = null;
	...
	private String createLFSSimulationFile(File lfsSimulationFilePath, File expData) throws IOException, AutoMechCalibAgentException {
	...
	private void convertCoMoCTMLToCanteraCTML(File comoCTML, File canteraCTML) throws IOException, AutoMechCalibAgentException, TransformerException {
