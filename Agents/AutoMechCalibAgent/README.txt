############################################
## AutoMechCalibAgent deploy instructions ##
############################################

This file gives the basic instructions for deploying the AutoMechCalibAgent. 
...
* Start Tomcat, this should only be done after "CATALINE_HOME" is correctly set:
   ...
   - Copy modified JPS_BASE##1.3.0.war and AutoMechCalibAgent.war into folder %CATALINA_HOME%\webapps\
* Now you can send job request in the format of HTTP request starting with "/AutoMechCalibAgent/coordination/request?query=<yourQueryString>"
