 ...
 * @param nestedClass    Nested concept if the property is nested under sh:node
 ...
 *                       predicate
 */
public record SparqlQueryLine(String property, String instanceClass, String nestedClass, String subject,
        String predicate, String labelPredicate, String subjectFilter, String branch, boolean isOptional,
        boolean isClazz) {
}