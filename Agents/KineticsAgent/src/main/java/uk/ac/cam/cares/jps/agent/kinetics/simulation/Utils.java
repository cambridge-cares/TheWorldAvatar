...
public class Utils {
	 ...
	 * the instance of Kinetics Agent.
	 * 
	 * @return
	 */
	 ...
	 * a Kinetics calculation was performed. 
	 * 
	 * @param jobFolder
	 ...
	 * @throws IOException
	 */
	public static String getUniqueSpeciesIRI(File jobFolder, KineticsAgentProperty kineticsAgentProperty) throws IOException{
		BufferedReader br = openSourceFile(jobFolder.getAbsolutePath().concat(File.separator).concat(kineticsAgentProperty.getJsonInputFileName()).concat(kineticsAgentProperty.getJsonFileExtension()));
	 ...
	 * @throws IOException
	 */
	public static boolean isInvokingThermoAgentRequired(File jobFolder, KineticsAgentProperty kineticsAgentProperty) throws IOException{
		BufferedReader br = openSourceFile(jobFolder.getAbsolutePath().concat(File.separator).concat(kineticsAgentProperty.getJsonInputFileName()).concat(kineticsAgentProperty.getJsonFileExtension()));
		String fileContent = getFileContent(br);
	 ...
	 * @throws IOException
	 */
	public static boolean isApplyingThermoUpdateToMechanismRequired(File jobFolder, KineticsAgentProperty kineticsAgentProperty) throws IOException{
		BufferedReader br = openSourceFile(jobFolder.getAbsolutePath().concat(File.separator).concat(kineticsAgentProperty.getJsonInputFileName()).concat(kineticsAgentProperty.getJsonFileExtension()));
		String fileContent = getFileContent(br);
