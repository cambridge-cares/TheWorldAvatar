...
import com.cmclinnovations.jps.agent.quantum.calculation.KineticsAgent;
import com.cmclinnovations.jps.agent.quantum.calculation.KineticsAgentException;
...
public class OntoSpeciesKG{
	...
	public static void main(String[] args) throws ServletException, KineticsAgentException{
//		OntoSpeciesKG ontoSpeciesKG = new OntoSpeciesKG();
//		KineticsAgent kineticsAgent = new KineticsAgent();
//		kineticsAgent.init();
//		for(String speciesIRI:kineticsAgent.ontoSpeciesIRIs){
...
//		}
	 ...
	 */
	public String querySpeciesGeometry(String speciesIRI, KineticsAgentProperty kineticsAgentProperty) throws KineticsAgentException{
		...
		System.out.println("QueryString:"+queryString+"\n");
		List<String> testResults = queryRepository(kineticsAgentProperty.getRdf4jServerURL(), Property.RDF4J_ONTOSPECIES_REPOSITORY_ID.getPropertyName(), queryString);
		for(String testResult: testResults){
//			System.out.println("Test Result:\n"+testResult);
	 ...
	 * @throws KineticsAgentException
	 */
	public List<String> getAllSpecies() throws KineticsAgentException{
	...
	public List<String> queryRepository(String serverURL, String repositoryID, String queryString)
		...
		try {
			...
			try {
				...
				e.printStackTrace();
				throw new KineticsAgentException("Exception occurred.");
			} finally {
			...
			e.printStackTrace();
			throw new KineticsAgentException("RDF4JException occurred.");
		}
