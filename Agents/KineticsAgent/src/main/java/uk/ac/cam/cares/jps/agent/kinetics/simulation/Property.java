 ...
 * Kinetics Agent. Some example properties are:</br>
 * - the name of the agent class</br>
 * - the name of the workspace folder on the machine where the agent runs</br>
 * - the name of the workspace folder on HPC where Kinetics calculations run</br>
 *  
...
public enum Property {
	...
	PREFIX_MSM("msm"),
	PREFIX_RAM("ram"),
	Kinetics_AGENT_IRI("<http://www.theworldavatar.com/kb/agents/Service__Kinetics.owl#Service>"),
