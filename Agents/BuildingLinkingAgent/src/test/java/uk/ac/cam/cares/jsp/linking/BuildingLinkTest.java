...
class BuildingLinkTest {
    ...
    private String queryEndpoint = "http://10.25.188.58:9999/blazegraph/namespace/carpark/sparql";
...
//        when(request.getParameter("iri")).thenReturn("http://10.25.188.58:9999/blazegraph/namespace/carpark/sparql");
