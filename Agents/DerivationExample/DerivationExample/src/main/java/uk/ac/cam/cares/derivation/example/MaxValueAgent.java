...
public class MaxValueAgent extends JPSAgent {
	/**
	 * 
	 */
    ...
    public JSONObject processRequestParameters(JSONObject requestParams) {
    	...
    	if (validateInput(requestParams, sparqlClient)) {
			...
			createdInstances.add(sparqlClient.addValueInstance(createdInstances.get(0), maxvalue));
			...
			LOGGER.info("Created a new max value instance <" + createdInstances.get(0) + ">");
    	}
