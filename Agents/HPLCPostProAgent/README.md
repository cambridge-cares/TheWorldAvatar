...
2022-05-25 12:53:14,508 (STDOUT) HPLCReport <http://example.com/blazegraph/namespace/testlab/dummy_lab_for_post_proc/HPLCReport_73e0b361-9960-454c-9d7a-11f3adb240cc> is connected to ChemicalAmount <http://example.com/blazegraph/namespace/testlab/dummy_lab_for_post_proc/ChemicalAmount_1_1>
```
