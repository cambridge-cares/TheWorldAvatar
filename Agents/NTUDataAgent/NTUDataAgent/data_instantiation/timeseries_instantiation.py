...
from NTUDataAgent.kg_utils.tsClientForUpdate import TSClientForUpdate
from NTUDataAgent.error_handling.exceptions import TSException
...
class timeseries_instantiation:
    ...
    def link_to_NTU_KG(pv_iri: str, dataIRIs: list, query_endpoint: str, update_endpoint: str):
        kg_client = KGClient(query_endpoint=query_endpoint, update_endpoint=update_endpoint)
        ...
        update = create_sparql_prefix('powreal') + \
                ...
                ''' % (pv_iri, gpIRI, gpIRI, gpIRI, dataIRIs[0], dataIRIs[0])
