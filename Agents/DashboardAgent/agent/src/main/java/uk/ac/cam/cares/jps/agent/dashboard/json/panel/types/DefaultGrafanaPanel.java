...
public abstract class DefaultGrafanaPanel extends TemplatePanel {
     ...
     */
    protected DefaultGrafanaPanel(String measure, String itemGroup, String databaseId, List<String[]> timeSeriesMetadata) {
     ...
     * @param databaseId The database connection ID generated by Grafana.
     */
    protected DefaultGrafanaPanel(String measure, String databaseId) {
        super();
