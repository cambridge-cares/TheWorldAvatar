...
class PostgresVariable extends TemplateVariable {
    ...
    private static final String REPEAT_SQL_QUERY_PART = ") AS v(k,v)  WHERE k IN (${";
    ...
    public PostgresVariable(String itemType, Map<String, List<String>> facilityItemMapping, String databaseId) {
        ...
        this.querySyntax.append(temp).append(REPEAT_SQL_QUERY_PART).append(StringHelper.FACILITY_KEY).append("});");
    }
    ...
    public PostgresVariable(String measure, String item, String databaseId, List<String[]> assetMeasures) {
        ...
        this.querySyntax.append(temp).append(REPEAT_SQL_QUERY_PART).append(itemVariable).append("});");
    }
