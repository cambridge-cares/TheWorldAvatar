...
class TimeSeriesChart {
     ...
     * @param tableName  The name of the table to query this data from.
     * @param databaseId The database connection ID generated by Grafana.
     */
    public TimeSeriesChart(String measure, String assetType, String tableName, String databaseId) {
        // Title is Measure of Asset Type
        this.TITLE = StringHelper.addSpaceBetweenCapitalWords(measure) + " of " + StringHelper.addSpaceBetweenCapitalWords(assetType);
