...
public class TimeSeriesChart extends DefaultGrafanaPanel {
     ...
     */
    public TimeSeriesChart(Measure measure, String itemGroup, String databaseId, String[] thresholds) {
        super("timeseries", itemGroup, databaseId, measure);
        ...
        String titleContent = StringHelper.addSpaceBetweenCapitalWords(measureName) + " of " + StringHelper.addSpaceBetweenCapitalWords(itemGroup);
        ...
        String description = "A chart displaying the time series of " + measureName.toLowerCase() + " for " + itemGroup.toLowerCase();
