        ...
        switch (chartType) {
            ...
            case 2:
                ...
                query = "SELECT CASE" +
                        ...
                        "WHERE CASE" +
                        " WHEN '${" + timeIntervalVariableName + ":csv}'='" + TemporalInterval.DAILY_OVER_WEEK + "' THEN time BETWEEN TO_TIMESTAMP(${__to}/1000)-interval'14 day' AND TO_TIMESTAMP(${__to}/1000)-interval'7 day'" +
                        " WHEN '${" + timeIntervalVariableName + ":csv}'='" + TemporalInterval.DAILY_OVER_MONTH + "' THEN time BETWEEN TO_TIMESTAMP(${__to}/1000)-interval'2 month' AND TO_TIMESTAMP(${__to}/1000)-interval'1 month'" +
                        " WHEN '${" + timeIntervalVariableName + ":csv}'='" + TemporalInterval.WEEKLY_OVER_MONTH + "' THEN time BETWEEN TO_TIMESTAMP(${__to}/1000)-interval'2 month' AND TO_TIMESTAMP(${__to}/1000)-interval'1 month'" +
                        " WHEN '${" + timeIntervalVariableName + ":csv}'='" + TemporalInterval.MONTHLY + "' THEN time BETWEEN TO_TIMESTAMP(${__to}/1000)-interval'2 year' AND TO_TIMESTAMP(${__to}/1000)-interval'1 year'" +
                        " END " +
