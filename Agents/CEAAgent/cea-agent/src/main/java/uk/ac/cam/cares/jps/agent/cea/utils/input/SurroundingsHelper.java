...
public class SurroundingsHelper {
     ...
     */
    public ArrayList<CEAInputData> getSurroundings(String buildingFootprint, String route, List<String> unique, List<Coordinate> surroundingCoordinates, String crs) {
        try {
            CEAInputData temp;
            String uri;
            ...
            JSONArray queryResultArray = AccessAgentCaller.queryStore(route, query.toString());
