...
public class DataRetriever {
     ...
     * @param value    type of data from CEAConstants.TIME_SERIES or
     *                 CEAConstants.SCALARS
    ...
    public static ArrayList<String> getDataIRI(String building, String value, String route) {
        ...
        addWhereForBuilding(wb, building, value);
    ...
    private static void addWhereForBuilding(WhereBuilder wb, String building, String value) {
        switch (value) {
            ...
            case CEAConstants.KEY_PVT_PLATE_ROOF_E_SUPPLY:
                addSupplyDeviceWhere(wb, "ontoubemmp:PVTPlateCollector", "ontoubemmp:ElectricitySupply",
                        "obs:RoofFacade");
                break;
            ...
            case CEAConstants.KEY_PVT_PLATE_WALL_SOUTH_Q_SUPPLY:
                addSupplyDeviceWhere(wb, "ontoubemmp:PVTPlateCollector", "ontoubemmp:HeatSupply",
                        "obs:SouthWallFacade");
                break;
            ...
            case CEAConstants.KEY_PVT_TUBE_ROOF_E_SUPPLY:
                addSupplyDeviceWhere(wb, "ontoubemmp:PVTTubeCollector", "ontoubemmp:ElectricitySupply",
                        "obs:RoofFacade");
                break;
            ...
            case CEAConstants.KEY_THERMAL_PLATE_WALL_SOUTH_SUPPLY:
                addSupplyDeviceWhere(wb, "ontoubemmp:ThermalPlateCollector", "ontoubemmp:HeatSupply",
                        "obs:SouthWallFacade");
                break;
            ...
            case CEAConstants.KEY_THERMAL_TUBE_WALL_SOUTH_SUPPLY:
                addSupplyDeviceWhere(wb, "ontoubemmp:ThermalTubeCollector", "ontoubemmp:HeatSupply",
                        "obs:SouthWallFacade");
                break;
    ...
    public static JSONArray bulkGetDataIRI(String building, String route) {
        ...
        for (String measurement : allMeasures) {
            ...
            wb.addPrefix("ocgml", OntologyURIHelper.getOntologyUri(OntologyURIHelper.ocgml))
                ...
                .addPrefix("ontoubemmp", OntologyURIHelper.getOntologyUri(OntologyURIHelper.ontoUBEMMP))
                .addPrefix("obs", OntologyURIHelper.getOntologyUri(OntologyURIHelper.ontobuiltstructure));
            addWhereForBuilding(wb, building, measurement);
            if (addAsUnion) {
                sb.addUnion(wb);
            } else {
                sb.addWhere(wb);
     ...
     * @param facadeType    type of facade that the generator is theoretically
     *                      installed on
     */
    public static void addSupplyDeviceWhere(WhereBuilder builder, String generatorType, String energyType,
            String facadeType) {
