...
How to view docker logs, webservlet
1) Docker ps
2) docker exec -it my-tomcat-container sh
3) cd /usr/local/tomcat/logs
4) ls
- this is to see all the files
5) tail -n 100 catalina.2023-02-23.log