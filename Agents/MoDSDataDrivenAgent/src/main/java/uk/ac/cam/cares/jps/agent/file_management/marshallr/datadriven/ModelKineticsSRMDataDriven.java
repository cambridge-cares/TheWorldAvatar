...
public class ModelKineticsSRMDataDriven extends MoDSMarshaller implements IModel {
	private static Logger logger = LoggerFactory.getLogger(ModelKineticsSRMDataDriven.class);
	...
	public ModelKineticsSRMDataDriven(MoDSDataDrivenAgentProperty modsDataDrivenAgentProperty) {
...
//	 */
//	@Override
//	public List<String> formFiles(ExecutableModel exeModel) throws IOException, MoDSDataDrivenAgentException {
//		return null;
//	}
//	
	...
	public List<String> formFiles(ExecutableModel exeModel, String otherOptions) throws IOException, MoDSDataDrivenAgentException {
		...
		// set up relative perturbation for data driven
	 ...
	 */
	@Override
	public List<String> createFolderInitial(List<String> processedActiveParam) throws IOException, MoDSDataDrivenAgentException {
	...
	public void setUpMoDS() throws IOException, MoDSDataDrivenAgentException {
		...
		LinkedHashMap<String, String> algoDataDriven = new LinkedHashMap<String, String>();
		algoDataDriven.put("optimisable_param_subtypes", active_subtype.substring(1));
		algoDataDriven.put("response_param_subtypes", "subtype_".concat(outputResponses.get(0)));
		algoDataDriven.put("algorithm_type", "Run");
		algoDataDriven.put("n_run", "0");
		algoDataDriven.put("data_driven", "true");
		algoDataDriven.put("relative_perturbation", getRelPerturbation());
		
		algorithms.put("DataDriven", algoDataDriven);
		...
		model.put("args", modsDataDrivenAgentProperty.getKineticsFolderPath().concat(SPACE).concat(modsDataDrivenAgentProperty.getKineticsExecutableName()));
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	private String copyMechanismFile(File copyOfMechanismFilePath, File mechanism) throws IOException, MoDSDataDrivenAgentException {
		// create the BufferedReader and BufferedWriter to read and write files
		BufferedReader br = null;
		BufferedWriter bw = null;
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	private String createInputParamsFile(File inputParamsFilePath, File expData) throws IOException, MoDSDataDrivenAgentException {
