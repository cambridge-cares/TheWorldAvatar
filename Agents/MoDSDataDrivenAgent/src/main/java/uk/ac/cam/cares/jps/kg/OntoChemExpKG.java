...
public class OntoChemExpKG {
	...
	public OntoChemExpKG(MoDSDataDrivenAgentProperty modsDataDrivenAgentProperty) {
	 ...
	 */
	public DataTable formatFlameSpeedExpDataTable(String experimentIRI) throws MoDSDataDrivenAgentException {
		// TODO
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	public DataTable formatExperimentDataTable(String experimentIRI) throws MoDSDataDrivenAgentException {
		List<String> columnTitles = new ArrayList<String>();
		List<List<String>> experimentData = new ArrayList<List<String>>();
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	public List<List<String>> queryConcentration(String experimentIRI) throws MoDSDataDrivenAgentException {
		...
		List<List<String>> testResults = RepositoryManager.queryRepository(modsDataDrivenAgentProperty.getRdf4jServerURL(), 
				modsDataDrivenAgentProperty.getRdf4jRepositoryOntoChemExp(), queryString);
		return testResults;
	}
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	public List<List<String>> queryEquivalenceRatio(String experimentIRI) throws MoDSDataDrivenAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	public List<List<String>> queryExperimentData(String experimentIRI) throws MoDSDataDrivenAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
	 ...
	 * @throws MoDSDataDrivenAgentException
	 */
	public List<List<String>> queryFlameSpeedExpData(String experimentIRI) throws MoDSDataDrivenAgentException {
		if(!experimentIRI.trim().startsWith("<") && !experimentIRI.trim().endsWith(">")){
			experimentIRI = "<".concat(experimentIRI).concat(">");
		}
