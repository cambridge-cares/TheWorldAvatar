...
public class HeatNetworkInputAgent{
    ...
    public void dataInstantiation() {
    	...
    	String staticData = "/Users/HXUE01/Documents/GitHub/TheWorldAvatar/Agents/DistrictHeatingNetworkAgent/bin/config/StaticDataHeatingNetwork.csv";
    	
    	String[] numericValue = ReadCol(1,staticData,",");
        ...
        public static void HeatHeneratorUpdate (String HeatGenerator_instance, float Value_ThermalLoad, float Value_HCV, float Value_LCV, float Value_CO2Factor) {
        ...
        public static void omHasValueTS (String Instance, String Unit) {	
