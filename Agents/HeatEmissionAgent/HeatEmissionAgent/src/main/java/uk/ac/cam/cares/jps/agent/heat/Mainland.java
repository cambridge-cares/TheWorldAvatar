...
public class Mainland {
    ...
    private void getCompanyProperties() {
        ...
        wb.addWhere("?plant", "ontocompany:hasDesignCapacity/om:hasValue/om:hasNumericalValue", designCapacity)
                .addWhere("?plant", "ontocompany:hasSpecificEnergyConsumption/om:hasValue/om:hasNumericalValue",
        ...
        for (int i = 0; i < queryResult.length(); i++) {
            ...
            Factory fac = new Factory(iri, facilityType.get(plantType), capacity, specificEnergy, efficiency);
            fac.calculateHeat();
            factories.add(fac);
        }
        ...
        factories.stream().forEach(fac -> {
            ...
            ub.addInsert(NodeFactory.createURI(heatIri), NodeFactory.createURI(hasValue),
                    ...
                    .addInsert(NodeFactory.createURI(measureIri),
                            ...
                            NodeFactory.createLiteral(Double.toString(fac.heatEmission), XSDDatatype.XSDdouble));
