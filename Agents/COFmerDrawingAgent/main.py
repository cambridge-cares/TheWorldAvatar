        ...
        for cof_row in cof_reader:
            ...
            with open(linkage_path, 'r', encoding='utf-8') as linkage_file:
                ...
                for linkage_row in linkage_reader:
                    if linkage_row['Linkage'] == linkage_lcr:
                        linkage = {
                            ...
                            "BS": [
                                {
                                    ...
                                    "bsIndex": int(linkage_row["bsIndex"]) # Converting bsIndex to integer
                                }
                            ]
                        }
                    #    print(linkage)
            ...
            #print("--------------------------------------------")
            run_cofmer_pipeline(assembly_model_dict, componentTypeNumber, precursor_values_1, linkage, input_dir, full_output_path)
