 ...
 * @author  */
class HistoricalPirmasensStationCSVConnector{
    ...
    public JSONObject getReadings() {
        try {
            return retrieveReadings(System.getenv("READINGS"), Integer.valueOf(numOfKeys));
        }
    ...
    public JSONObject retrieveReadings(String filePath, int numOfKeys) throws IOException, JSONException {
		...
		int totalNumOfRows = countNumberOfRows(filePath);
	    dataList = new Double[totalNumOfRows * 24];
		keys = new String[totalNumOfRows];
		dateList = new String[totalNumOfRows];
		LOGGER.info("The total number of rows is " + totalNumOfRows);
		...
		while (sc.hasNext()) {
				...
				//'PS-Innenstadt';'Gesamt-UV Strahlung';'20220707';0.21651599;0.09434250;0.15619700;0.12448200;0.35326499;2.42124510;5.18091965;8.85325050;5.12361002;8.65175056;14.35159969;14.73234940;14.12985039;20.10925102;24.28499985;12.69910049;7.40499973;6.47114992;3.44150996;2.44336009;0.42795300;0.10956550;0.05604300;0.19735551;-999
				data = sc.next();
				...
				/*
					...
					throw new JPSRuntimeException("There was an error while retrieving the dates from the CSV file!");
				}
				*/
