...
public class HistoricalAQMeshAgentTest {
    ...
    private HistoricalAQMeshAgent testAgent;
    ...
    public void initializeAgent() throws IOException {
        ...
        writePropertyFile(propertiesFile, Collections.singletonList("aqmesh.mappingfolder=TEST_MAPPINGS"));
        ...
        try {
        	SystemLambda.withEnvironmentVariable("TEST_MAPPINGS", mappingFolder.getCanonicalPath()).execute(() -> {
        		 testAgent = new HistoricalAQMeshAgent(propertiesFile);
        	 });
        }
    ...
    public void createExampleReadings() {
        ...
        for(String timestamp: timestamps) {
            ...
            currentGasMeasures.put(HistoricalAQMeshAgent.timestampKey, timestamp);
            currentParticleMeasures.put(HistoricalAQMeshAgent.timestampKey, timestamp);
    ...
    public void testConstructor() throws IOException {
    	        ...
    	        try {
    	            new HistoricalAQMeshAgent(propertiesFile);
    	            Assert.fail();
    	        }
    	        
    	        catch (IOException e) {
    	            Assert.assertEquals("The key aqmesh.mappingfolder cannot be found in the properties file.", e.getMessage());
    	        }
    	        ...
    	        try {
    	        	SystemLambda.withEnvironmentVariable("TEST_MAPPINGS", mappingFolder.getCanonicalPath()).execute(() -> {
    	        		HistoricalAQMeshAgent agent = new HistoricalAQMeshAgent(propertiesFile);
    ...
    public void testTimeSeriesExistAllIRIsTrue() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        Method timeSeriesExist = HistoricalAQMeshAgent.class.getDeclaredMethod("timeSeriesExist", List.class);
    ...
    public void testUpdateDataExceptions() {
        ...
        for(String timestamp: timestamps) {
            String json = "{ '" + HistoricalAQMeshAgent.timestampKey + "':'" + timestamp + "'}";
    ...
    public void testJsonArrayToMapEmptyReadings() throws NoSuchMethodException, InvocationTargetException,
        ...
        // Make method accessible
        Method jsonArrayToMap = HistoricalAQMeshAgent.class.getDeclaredMethod("jsonArrayToMap", JSONArray.class);
    ...
    public void testConvertReadingsToTimeSeries() throws IOException, NoSuchMethodException,
        ...
        particleReadings.put(HistoricalAQMeshAgent.timestampKey, Arrays.asList(particleTimestamps));
        // Gas readings
        String[] gasTimestamps = {"2021-07-11T16:20:00", "2021-07-11T16:25:00", "2021-07-11T16:30:00"};
        Map<String, List<?>> gasReadings = new HashMap<>();
        gasReadings.put(HistoricalAQMeshAgent.timestampKey, Arrays.asList(gasTimestamps));

        // Make method accessible
        Method convertReadingsToTimeSeries = HistoricalAQMeshAgent.class.getDeclaredMethod("convertReadingsToTimeSeries", Map.class, Map.class);
    ...
    public void testConvertStringToOffsetDateTime() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        // Make method accessible
        Method convertStringToOffsetDateTime = HistoricalAQMeshAgent.class.getDeclaredMethod("convertStringToOffsetDateTime", String.class);
