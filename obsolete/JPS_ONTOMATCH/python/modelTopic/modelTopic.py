...
class topicModel(object):
    ...
    def LDA(self,numTopics, numPasses, numWords, modelname, alpha = "auto", numTopicsPrint = -1):
        print('now LDA model')
        if type(alpha) != str:
        ...
        #self.ldamodels.save('../model/modelBase/'+str(numTopics)+'t'+str(numPasses)+'p'+str(alpha)+'a.gensim')
        self.ldamodels.save(modelname)
...
if __name__ == '__main__':
    ...
    tm = topicModel(sys.argv[0], addrDict=sys.argv[1], addrFile= sys.argv[2],mode = 'save')
