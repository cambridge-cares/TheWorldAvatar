...
public interface IRepositoryManager {
	...
	public List<String> queryRepositoryExperimentalData(String serverURL, String repositoryID, String queryString) throws OntoException, MoDSMechCalibAgentException;
	public List<List<String>> queryRepository(String serverURL, String repositoryID, String queryString) throws MoDSMechCalibAgentException;
