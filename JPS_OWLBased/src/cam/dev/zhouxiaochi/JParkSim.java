...
change.setLocation(890, 45);
  ...
  //button for query (15-04-2016))
	...
	BtnInfo[] btnInfos = new BtnInfo[5];
	btnInfos[0] = new RefreshBtnInfo(layers, graphicsLayer, completeLayerList);
	btnInfos[1] = new PrBtnInfo(completeLayerList, "You did not edit any features for PowerWorld!",
			"PrPowerWorld has finished evaluating!", "An error has occurred with HTTP request.", 
           "PWPr", editStack);
	btnInfos[2] = new PrBtnInfo(completeLayerList, "You did not edit any features for AspenPlus!", 
			"Parameterized AP & PW has finished running!", "An error has occurred with HTTP request." ,
			 "PrAPPW", editStack);	
	btnInfos[3] = new QueryBtnInfo(completeLayerList, "You did not input any queries!", 
			"Query has been performed successfully", "An error has occurred with HTTP request." ,
