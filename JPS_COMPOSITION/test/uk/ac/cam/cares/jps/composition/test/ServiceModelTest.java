...
public class ServiceModelTest {
	...
	public void test() throws URISyntaxException, IOException {
		...
		MessagePart MessagePartConvertedBack = mapper.readValue(MessagePartInJSON, MessagePart.class);
		System.out.println("MessagePartConvertedBack");

	
		MessageContent messageContent_input = new MessageContent(new URI("http://www.theworldavatar.com/weatherInXYZ123"));
		messageContent_input.addMandatoryPart(messagePartCity);
		messageContent_input.addOptionalPart(messagePartDate);
		
		MessagePart messagePartTemperature = new MessagePart(new URI("http://www.theworldavatar.com/wOutParamTempXYX123"));
		messagePartTemperature.setModelReference(new URI("http://www.theworldavatar.com/Weather.owl#Temperature"));
		MessagePart messagePartWinddirection = new MessagePart(new URI("http://www.theworldavatar.com/wOutParamWindXYX123"));
		...
		System.out.println(MessageContentInJSON);
		MessageContent MessageContentConvertedBack = mapper.readValue(MessageContentInJSON, MessageContent.class);
		...
		Service service2 = new Service(new URI("http://www.theworldavatar.com/ADMS/anthorRandomService001"));
		Operation operation2 = new Operation(new URI("http://www.theworldavatar.com/ADMS/anotherRandomOperation001"), "http://www.theworldavatar.com/ADMS/anotherRandomOperationHTTPURL");
		MessageContent inputOfOperation2 = new MessageContent(new URI("http://www.theworldavatar.com/inputOfanotherRandomOperation001"));
		MessagePart param1OfInputOfOperation2 = new MessagePart(new URI("http://www.theworldavatar.com/param1OfInputOfOperation2"));
