...
public class FormatTranslator {
	...
	public static Service convertJSONTOJavaClass(String agentInJSONString) throws URISyntaxException, JsonParseException, JsonMappingException, IOException {
	...
	public static JSONObject convertGraphJavaClassTOJSON(Graph graphInJava) throws JsonProcessingException, JSONException {
		ObjectMapper mapper = new ObjectMapper();
		mapper.setSerializationInclusion(Include.NON_NULL);
		mapper.setSerializationInclusion(Include.NON_EMPTY);
