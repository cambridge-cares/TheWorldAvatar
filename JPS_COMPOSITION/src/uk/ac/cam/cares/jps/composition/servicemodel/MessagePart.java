...
public class MessagePart {
	...
	/*
	 * A messagePart represents an input parameter for a semantic web service It is
	 * currently an extension of class Resource, which requires an IRI(URI) to
	 * construct A messagePart can be merely a
	 */
