...
To run these test cases, copy the folders to your home directory on CSD3. Then run the following commands:
cd ~/testcase1/
...
Once the first test case has completed, proceed to run the rest, i.e.:
cd ~/testcase2/
sbatch --job-name=input Slurm.sh
...
The main output file to compare is 3D_instantanous_mainconc_center.dat, reference output files are available for each test case for comparison.