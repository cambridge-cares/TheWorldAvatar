! <pot_tmpgr_new.f90 - A component of the City-scale
...
!*****************************************************************************! 
      ...
      subroutine POT_TMPGR_NEW(A,B,C,Z,DTHDZ)
!   ------------------------------------------------------------------
!        Subroutine for calculations of the vertical potential
...
!                Z = The height (m) at which the gradient is computed
!
