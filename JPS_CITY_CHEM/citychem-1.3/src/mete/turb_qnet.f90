...
!*****************************************************************************! 
      ...
      subroutine turb_qnet(ANALYTIC,G,SIGMA,D_ADIAB,KAPPA,CP,RHO_AIR,  &
                           LAMBDA_E,S_SLOPE,TAY_PRI,AG_DAY,AG_NIGHT,   &
                           THETA_D,U1,U2,ZU1,ZU2,Z0H,ZR,TM,RNN,QNET,   &
                           LOWER_LIM_L,UST,TST,QST,CL)

! ----------------------------------------------------------------------
!
!     SUBROUTINE TURB_QNET computes FRICTION VELOCITY from wind 
!     measurements at two heights, measured net radiation, QNET, 
!     and parameterized surface heat flux (van Ulden and Holtslag,
!     1985).
!
...
!     Global variables:
      ...
      real,intent(IN)    :: G,SIGMA,D_ADIAB,KAPPA,CP,RHO_AIR,LAMBDA_E,   &
                            ...
                            U1,U2,ZU1,ZU2,Z0H,ZR,TM,RNN,QNET,LOWER_LIM_L
      real,intent(OUT)   :: UST,TST,QST,CL
!
!	Local variables:
      integer :: N,NRIT
      real    :: ALFA,CLP,ZETA,CL0,TCL,CLN,DL,ADL,ADL_LIM
!             
! ----------------------------------------------------------------------
...
!MSK               UST = (U2-U1)*KAPPA/( ALOG(ZU2/ZU1)-PSIM(ZU2/CL)+PSIM(ZU1/CL))
  ...
  20  CONTINUE          
!_LHS:      PRINT *, 'NOT ACHIEVED CONVERGENCE in TURB_QNET.'
!_LHS:      STOP
      
  25  CONTINUE

      RETURN
      end subroutine turb_qnet
