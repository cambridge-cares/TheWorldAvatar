! <build.f90 - A component of the City-scale
...
!*****************************************************************************!
      ...
      subroutine BUILD(BH,BW,HS,V,HF,HP,DHM,IDH,IWASH)
...
! DHM   - Delta height due to momentum rise
