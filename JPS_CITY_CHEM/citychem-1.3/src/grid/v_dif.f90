! <v_dif.f90 - A component of the City-scale
...
! *** The subroutine calculates vertical diffusion for compound
! *** with index IC.
...
!     
!_LHS_DRYDEP_September_2004_End.
...
!MSK            IF (C(IC,I+1,J+1,K) .LT. -1.E-37 .AND. IC .NE. 39) THEN
...
! ***         Set negative concentrations to zero:
 ...
 1000 format ('V_DIF: Timestep = ',I3,' IC = ',I2,' I = ',I3,' J = ',    &
             I3,' K = ',I2,1P,' C(IC,I,J,K) = ',E12.4,    &
             ' DCDT(IC,I,J,K) = ',E12.4)

! *** End of subroutine V_DIF

      end subroutine v_dif
