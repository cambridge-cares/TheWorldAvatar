! <getrwf.f90 - A component of the City-scale
...
! Filename extension found. Default is ASCII.

          IRWF = 1

! NILUs simple field ASCII  format

          IF (FN(I1:I2) .EQ. 'asc') IRWF = 1

! NILUs simple field Binary format

          IF (FN(I1:I2) .EQ. 'fld') IRWF = 2

! NetCDF field format

          IF (FN(I1:I2) .EQ. 'nc' ) IRWF = 3

! HDF field format

          IF (FN(I1:I2) .EQ. 'hdf') IRWF = 4

! NILUs field print format

          IF (FN(I1:I2) .EQ. 'prn') IRWF = 5

! NILUS ASCII-files with heading:
         
          IF (FN(I1:I2) .EQ. 'txt') IRWF = 6
