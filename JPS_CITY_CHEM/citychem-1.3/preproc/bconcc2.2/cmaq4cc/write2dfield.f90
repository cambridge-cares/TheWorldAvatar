! <write2dfield.f90  - A component of the City-scale
...
!* ========================================== 
!*
      subroutine write2dfield(nx,ny,txt1,txt2,un,fm,f2d)
...
! ***   line after the final data line.:
        write (un,'(2A10,2I3,/,32767(2I3,1P,E12.4,/))') txt1,txt2,nx,ny, &
