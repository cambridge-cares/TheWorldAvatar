...
# This is the script for the CONC files from CMAQ
...
#setenv GRIDDESC      ./city_grids/GRIDDESC_Gdansk
setenv GRIDDESC      ./city_grids/GRIDDESC_Hamburg

###   ENTER here the path of the CONC input files:
...
### Convert the CMAQ concentration CONC files
### Read and write from/to USB external drive
#setenv INFILE_SH     /media/matthias/TOSHIBA\ EXT/CMAQ/CD04a/CONC.CD04a_sheba.current_cb05tucl_ae5_aq_2012${strDAYin}
#setenv OUTFILE_SH    /media/matthias/TOSHIBA\ EXT/CMAQ/Gdansk/m3bcon.2012/conc_gdansk_2012${strDAYin}

setenv INFILE_SH     /home/matthias/CMAQ/CD04a/conc/CONC.CD04a_sheba.noship_cb05tucl_ae5_aq_2012${strDAYin}
setenv OUTFILE_SH    /home/matthias/CMAQ/Hamburg/m3bcon/conc_hh_2012${strDAYin}
