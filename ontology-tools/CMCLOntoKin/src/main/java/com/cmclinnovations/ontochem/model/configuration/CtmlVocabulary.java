...
public class CtmlVocabulary {
	...
	@Value("${ctml.phase.gas.element.data.id}")
	private String gasElementDataId;
	...
	@Value("${ctml.phase.gas.thermo.model.type}")
	private String gasPhaseThermoModelType;
	
	@Value("${ctml.phase.gas.tx.model.type.none}")
	private String gasPhaseTxModelTypeNone;

	@Value("${ctml.phase.gas.tx.model.type.mix}")
	private String gasPhaseTxModelTypeMix;
	
	@Value("${ctml.phase.material.name.starts.with}")
	private String materialNameStartsWith;

	@Value("${ctml.reaction.forward}")
	private String forwardReactionIndicator;

	@Value("${ctml.reaction.reverse}")
	private String reverseReactionIndicator;

	@Value("${ctml.is.element.data.case.sensitive}")
	private String isElementDataCaseSensitive;
			
	@Value("${ctml.is.species.data.case.sensitive}")
	private String isSpeciesDataCaseSensitive;

	@Value("${ctml.is.reaction.data.case.sensitive}")
	private String isReactionDataCaseSensitive;
	
	@Value("${ctml.species.nasa.floatarray.name}")
	private String SpeciesNasaFloatArrayName;
	...
	public String getForwardReactionIndicator() {
		return forwardReactionIndicator;
	}

	public void setForwardReactionIndicator(String forwardReactionIndicator) {
		this.forwardReactionIndicator = forwardReactionIndicator;
	}

	public String getReverseReactionIndicator() {
		return reverseReactionIndicator;
	}

	public void setReverseReactionIndicator(String reverseReactionIndicator) {
		this.reverseReactionIndicator = reverseReactionIndicator;
	}

	public String getIsSpeciesDataCaseSensitive() {
		return isSpeciesDataCaseSensitive;
	}

	public void setIsSpeciesDataCaseSensitive(String isSpeciesDataCaseSensitive) {
		this.isSpeciesDataCaseSensitive = isSpeciesDataCaseSensitive;
	}

	public String getIsReactionDataCaseSensitive() {
		return isReactionDataCaseSensitive;
	}

	public void setIsReactionDataCaseSensitive(String isReactionDataCaseSensitive) {
		this.isReactionDataCaseSensitive = isReactionDataCaseSensitive;
	}

	public String getGasElementDataId() {
		return gasElementDataId;
	}

	public void setGasElementDataId(String gasElementDataId) {
		this.gasElementDataId = gasElementDataId;
	}

	public String getIsElementDataCaseSensitive() {
		return isElementDataCaseSensitive;
	}

	public void setIsElementDataCaseSensitive(String isElementDataCaseSensitive) {
		this.isElementDataCaseSensitive = isElementDataCaseSensitive;
	}

	public String getGasPhaseThermoModelType() {
		return gasPhaseThermoModelType;
	}

	public void setGasPhaseThermoModelType(String gasPhaseThermoModelType) {
		this.gasPhaseThermoModelType = gasPhaseThermoModelType;
	}

	public String getSpeciesNasaFloatArrayName() {
		return SpeciesNasaFloatArrayName;
	}

	public void setSpeciesNasaFloatArrayName(String speciesNasaFloatArrayName) {
		SpeciesNasaFloatArrayName = speciesNasaFloatArrayName;
	}

	public String getGasPhaseTxModelTypeNone() {
		return gasPhaseTxModelTypeNone;
	}

	public void setGasPhaseTxModelTypeNone(String gasPhaseTxModelTypeNone) {
		this.gasPhaseTxModelTypeNone = gasPhaseTxModelTypeNone;
	}

	public String getGasPhaseTxModelTypeMix() {
		return gasPhaseTxModelTypeMix;
	}

	public void setGasPhaseTxModelTypeMix(String gasPhaseTxModelTypeMix) {
		this.gasPhaseTxModelTypeMix = gasPhaseTxModelTypeMix;
	}
}