...
public class OntoKinVocabulary {
	...
	@Value("${ontokin.compchem.git.commit.hash}")
	private String compChemGitCommitHash;

	@Value("${ontokin.compchem.git.commit.hash.value}")
	private String compChemGitCommitHashValue;
	...
	@Value("${ontokin.indicates.number.of.element}")
	private String indicatesNumberOf;
	...
	@Value("${ontokin.phase.contained.in}")
	private String objectPropertyContainedIn;
	...
	@Value("${ontokin.element.number}")
	private String ontokinElementNumber;
	
	@Value("${ontokin.phase.has.element.property}")
	private String objectPropertyHasElement;

	@Value("${ontokin.phase.has.element.number}")
	private String objectPropertyHasElementNumber;
	...
	@Value("${ontokin.ctml.species.thermo.quantum.calculation.iri}")
	private String dataPropertyQuantumCalculationIRI;

	@Value("${ontokin.ctml.species.thermo.agent.iri}")
	private String dataPropertyThermoAgentIRI;
	...
	@Value("${ontokin.compchem.species.unique.iri}")
	private String dataPropertyUniqueSpeciesIRI;
	...
	@Value("${ontokin.reaction.forward}")
	private String classForwardReaction;

	@Value("${ontokin.reaction.reverse}")
	private String classReverseReaction;
	...
	@Value("${ontokin.reaction.order.applies.to}")
	private String objectPropertyAppliesTo;

	@Value("${ontokin.reactant.or.product.participates.in}")
	private String objectPropertyParticipatesIn;
	...
	private String classPublicationSpecification;

	@Value("${ontokin.reference.journal.specification}")
	private String classJournalSpecification;

	@Value("${ontokin.reference.conference.proceedings.specification}")
	private String classConfProceedingsSpecification;

	@Value("${ontokin.reference.preprint.specification}")
	private String classPreprintSpecification;

	@Value("${ontokin.reference.has.journal}")
	private String objectPropertyHasJournal;

	@Value("${ontokin.reference.journal.volume}")
	private String dataPropertyJournalVolume;

	@Value("${ontokin.reference.document.page.start}")
	private String dataPropertyDocumentPageStart;
	
	@Value("${ontokin.reference.document.page.end}")
	private String dataPropertyDocumentPageEnd;

	@Value("${ontokin.reference.has.creator}")
	private String objectPropertyHasCreator;

	@Value("${ontokin.reference.has.publication.specification}")
	private String objectPropertyHasPublicationSpecification;	

	@Value("${ontokin.reference.has.contributor}")
	private String objectPropertyHasContributor;

	@Value("${ontokin.reference.issn}")
	private String dataPropertyIssn;

	@Value("${ontokin.reference.family.name}")
	private String dataPropertyFamilyName;

	@Value("${ontokin.reference.given.name}")
	private String dataPropertyGivenName;

	@Value("${ontokin.reference.name}")
	private String dataPropertyName;

	@Value("${ontokin.reference.has.reference}")
	private String objectPropertyHasReference;
	
	@Value("${ontokin.reference.publisher}")
	private String dataPropertyPublisher;	

	@Value("${ontokin.reference.title}")
	private String dataPropertyTitle;

	@Value("${ontokin.is-a.relation}")
	...
	@Value("${ontokin.ontology.data.of.publication}")
	private String annotationPropertyDate;

	@Value("${ontokin.comment}")
	private String annotationPropertyValueOfComment;

	@Value("${ontokin.indicates.multiplicity.of}")
	private String objectPropertyIndicatesMultiplicityOf;

	@Value("${ontokin.reaction.stoichiometric.coefficient}")
	private String classStoichiometricCoefficient;
	...
	public String getClassReactant() {
		return classReactant;
	}

	public void setClassReactant(String classReactant) {
		this.classReactant = classReactant;
	}
	...
	public String getObjectPropertyContainedIn() {
		return objectPropertyContainedIn;
	}

	public void setObjectPropertyContainedIn(String objectPropertyContainedIn) {
		this.objectPropertyContainedIn = objectPropertyContainedIn;
	}

	public String getDataPropertyIssn() {
		return dataPropertyIssn;
	}

	public void setDataPropertyIssn(String dataPropertyIssn) {
		this.dataPropertyIssn = dataPropertyIssn;
	}

	public String getDataPropertyFamilyName() {
		return dataPropertyFamilyName;
	}

	public void setDataPropertyFamilyName(String dataPropertyFamilyName) {
		this.dataPropertyFamilyName = dataPropertyFamilyName;
	}

	public String getDataPropertyGivenName() {
		return dataPropertyGivenName;
	}

	public void setDataPropertyGivenName(String dataPropertyGivenName) {
		this.dataPropertyGivenName = dataPropertyGivenName;
	}
	...
	public String getObjectPropertyHasCreator() {
		return objectPropertyHasCreator;
	}

	public void setObjectPropertyHasCreator(String objectPropertyHasCreator) {
		this.objectPropertyHasCreator = objectPropertyHasCreator;
	}

	public String getObjectPropertyHasJournal() {
		return objectPropertyHasJournal;
	}

	public void setObjectPropertyHasJournal(String objectPropertyHasJournal) {
		this.objectPropertyHasJournal = objectPropertyHasJournal;
	}
	...
	public void setClassAgent(String classAgent) {
	...
	public String getClassPublicationSpecification() {
		return classPublicationSpecification;
	}

	public void setClassPublicationSpecification(String classPublicationSpecification) {
		this.classPublicationSpecification = classPublicationSpecification;
	}

	public String getClassJournalSpecification() {
		return classJournalSpecification;
	}

	public void setClassJournalSpecification(String classJournalSpecification) {
		this.classJournalSpecification = classJournalSpecification;
	}

	public String getClassConfProceedingsSpecification() {
		return classConfProceedingsSpecification;
	}

	public void setClassConfProceedingsSpecification(String classConfProceedingsSpecification) {
		this.classConfProceedingsSpecification = classConfProceedingsSpecification;
	}

	public String getClassPreprintSpecification() {
		return classPreprintSpecification;
	}

	public void setClassPreprintSpecification(String classPreprintSpecification) {
		this.classPreprintSpecification = classPreprintSpecification;
	}

	public String getDataPropertyJournalVolume() {
		return dataPropertyJournalVolume;
	}

	public void setDataPropertyJournalVolume(String dataPropertyJournalVolume) {
		this.dataPropertyJournalVolume = dataPropertyJournalVolume;
	}

	public String getDataPropertyDocumentPageStart() {
		return dataPropertyDocumentPageStart;
	}

	public void setDataPropertyDocumentPageStart(String dataPropertyDocumentPageStart) {
		this.dataPropertyDocumentPageStart = dataPropertyDocumentPageStart;
	}

	public String getDataPropertyDocumentPageEnd() {
		return dataPropertyDocumentPageEnd;
	}

	public void setDataPropertyDocumentPageEnd(String dataPropertyDocumentPageEnd) {
		this.dataPropertyDocumentPageEnd = dataPropertyDocumentPageEnd;
	}

	public String getObjectPropertyHasPublicationSpecification() {
		return objectPropertyHasPublicationSpecification;
	}

	public void setObjectPropertyHasPublicationSpecification(String objectPropertyHasPublicationSpecification) {
		this.objectPropertyHasPublicationSpecification = objectPropertyHasPublicationSpecification;
	}

	public String getObjectPropertyHasContributor() {
		return objectPropertyHasContributor;
	}

	public void setObjectPropertyHasContributor(String objectPropertyHasContributor) {
		this.objectPropertyHasContributor = objectPropertyHasContributor;
	}

	public String getObjectPropertyHasReference() {
		return objectPropertyHasReference;
	}

	public void setObjectPropertyHasReference(String objectPropertyHasReference) {
		this.objectPropertyHasReference = objectPropertyHasReference;
	}

	public String getDataPropertyPublisher() {
		return dataPropertyPublisher;
	}

	public void setDataPropertyPublisher(String dataPropertyPublisher) {
		this.dataPropertyPublisher = dataPropertyPublisher;
	}

	public String getDataPropertyTitle() {
		return dataPropertyTitle;
	}

	public void setDataPropertyTitle(String dataPropertyTitle) {
		this.dataPropertyTitle = dataPropertyTitle;
	}

	public String getDataPropertyQuantumCalculationIRI() {
		return dataPropertyQuantumCalculationIRI;
	}

	public void setDataPropertyQuantumCalculationIRI(String dataPropertyQuantumCalculationIRI) {
		this.dataPropertyQuantumCalculationIRI = dataPropertyQuantumCalculationIRI;
	}

	public String getDataPropertyUniqueSpeciesIRI() {
		return dataPropertyUniqueSpeciesIRI;
	}

	public void setDataPropertyUniqueSpeciesIRI(String dataPropertyUniqueSpeciesIRI) {
		this.dataPropertyUniqueSpeciesIRI = dataPropertyUniqueSpeciesIRI;
	}

	public String getOntokinElementNumber() {
		return ontokinElementNumber;
	}

	public void setOntokinElementNumber(String ontokinElementNumber) {
		this.ontokinElementNumber = ontokinElementNumber;
	}

	public String getObjectPropertyHasElementNumber() {
		return objectPropertyHasElementNumber;
	}

	public void setObjectPropertyHasElementNumber(String objectPropertyHasElementNumber) {
		this.objectPropertyHasElementNumber = objectPropertyHasElementNumber;
	}

	public String getDataPropertyThermoAgentIRI() {
		return dataPropertyThermoAgentIRI;
	}

	public void setDataPropertyThermoAgentIRI(String dataPropertyThermoAgentIRI) {
		this.dataPropertyThermoAgentIRI = dataPropertyThermoAgentIRI;
	}
	...
	public String getCompChemGitCommitHashValue() {
		return compChemGitCommitHashValue;
	}

	public void setCompChemGitCommitHashValue(String compChemGitCommitHashValue) {
		this.compChemGitCommitHashValue = compChemGitCommitHashValue;
	}
	...
	public String getAnnotationPropertyValueOfVersion() {
		return annotationPropertyValueOfVersion;
	}

	public void setAnnotationPropertyValueOfVersion(String annotationPropertyValueOfVersion) {
		this.annotationPropertyValueOfVersion = annotationPropertyValueOfVersion;
	}
	...
	public String getAnnotationPropertyValueOfComment() {
		return annotationPropertyValueOfComment;
	}

	public void setAnnotationPropertyValueOfComment(String annotationPropertyValueOfComment) {
		this.annotationPropertyValueOfComment = annotationPropertyValueOfComment;
	}

	public String getIndicatesNumberOf() {
		return indicatesNumberOf;
	}

	public void setIndicatesNumberOf(String indicatesNumberOf) {
		this.indicatesNumberOf = indicatesNumberOf;
	}

	public String getObjectPropertyIndicatesMultiplicityOf() {
		return objectPropertyIndicatesMultiplicityOf;
	}

	public void setObjectPropertyIndicatesMultiplicityOf(String objectPropertyIndicatesMultiplicityOf) {
		this.objectPropertyIndicatesMultiplicityOf = objectPropertyIndicatesMultiplicityOf;
	}

	public String getClassStoichiometricCoefficient() {
		return classStoichiometricCoefficient;
	}

	public void setClassStoichiometricCoefficient(String classStoichiometricCoefficient) {
		this.classStoichiometricCoefficient = classStoichiometricCoefficient;
	}

	public String getClassForwardReaction() {
		return classForwardReaction;
	}

	public void setClassForwardReaction(String classForwardReaction) {
		this.classForwardReaction = classForwardReaction;
	}

	public String getClassReverseReaction() {
		return classReverseReaction;
	}

	public void setClassReverseReaction(String classReverseReaction) {
		this.classReverseReaction = classReverseReaction;
	}

	public String getObjectPropertyAppliesTo() {
		return objectPropertyAppliesTo;
	}

	public void setObjectPropertyAppliesTo(String objectPropertyAppliesTo) {
		this.objectPropertyAppliesTo = objectPropertyAppliesTo;
	}

	public String getObjectPropertyParticipatesIn() {
		return objectPropertyParticipatesIn;
	}

	public void setObjectPropertyParticipatesIn(String objectPropertyParticipatesIn) {
		this.objectPropertyParticipatesIn = objectPropertyParticipatesIn;
	}
}
