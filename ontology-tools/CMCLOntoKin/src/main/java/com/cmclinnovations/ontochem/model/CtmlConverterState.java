...
import com.cmclinnovations.ontochem.model.converter.ctml.IElementConverter;
import com.cmclinnovations.ontochem.model.converter.ctml.IMetadataConverter;
import com.cmclinnovations.ontochem.model.converter.ctml.IPhaseConverter;
import com.cmclinnovations.ontochem.model.converter.ctml.IReactionConverter;
import com.cmclinnovations.ontochem.model.converter.ctml.ISpeciesConverter;
import com.cmclinnovations.ontochem.model.converter.json.CompChemConverter;
import com.cmclinnovations.ontochem.model.converter.json.CompChemOwlWriter;
import com.cmclinnovations.ontochem.model.converter.owl.query.sparql.IElementQuery;
import com.cmclinnovations.ontochem.model.converter.owl.query.sparql.IMetadataQuery;
import com.cmclinnovations.ontochem.model.converter.owl.query.sparql.IPhaseQuery;
import com.cmclinnovations.ontochem.model.converter.owl.query.sparql.IReactionQuery;
import com.cmclinnovations.ontochem.model.converter.owl.query.sparql.ISpeciesQuery;
...
import com.cmclinnovations.ontochem.model.owl.IElementWriter;
import com.cmclinnovations.ontochem.model.owl.IMetadataWriter;
import com.cmclinnovations.ontochem.model.owl.IOwlConstructWriter;
import com.cmclinnovations.ontochem.model.owl.IPhaseWriter;
import com.cmclinnovations.ontochem.model.owl.IRateCoefficientWriter;
import com.cmclinnovations.ontochem.model.owl.IReactionWriter;
import com.cmclinnovations.ontochem.model.owl.ISpeciesWriter;
...
import com.cmclinnovations.ontochem.model.parser.ctml.ICtmlCommentParser;
import com.cmclinnovations.ontochem.model.parser.ctml.IElementDataParser;
import com.cmclinnovations.ontochem.model.parser.ctml.IMetadataParser;
import com.cmclinnovations.ontochem.model.parser.ctml.IPhaseParser;
import com.cmclinnovations.ontochem.model.parser.ctml.IReactionDataParser;
import com.cmclinnovations.ontochem.model.parser.ctml.ISpeciesDataParser;
import com.cmclinnovations.ontochem.model.parser.ctml.IValidateParser;
import com.cmclinnovations.ontochem.model.parser.ctml.elementdata.IElementParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IElementArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IKineticsParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IPhaseArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IPhaseThermoParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IReactionArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.ISpeciesArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.IStateParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.ITransportParser;
import com.cmclinnovations.ontochem.model.parser.ctml.phase.thermo.ISiteDensityParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.IReactionParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IArrheniusParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.ICoverageParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IEfficiencyParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IFallOffParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.ILandauTellerParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IRateCoeffArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IRateCoeffPressureMaxParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IRateCoeffPressureMinParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IRateCoeffTempMaxParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IRateCoeffTempMinParser;
import com.cmclinnovations.ontochem.model.parser.ctml.reactiondata.reaction.IReactionOrderParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.ISpeciesParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.IDensityParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.ISizeParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.ISpeciesThermoParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.ISpeciesTransportParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.nasa.ICoefficentArrayParser;
import com.cmclinnovations.ontochem.model.parser.ctml.speciesdata.species.nasa.INASAPolynomialParser;
import com.cmclinnovations.ontochem.model.reference.Doi;
import com.cmclinnovations.ontochem.model.reference.DoiParser;
import com.cmclinnovations.ontochem.model.reference.IDoi;
...
public class CtmlConverterState {
	...
	// Declared to serve as the id for instances of the Element Number class.
	public static long elementNumberInstanceId = System.nanoTime();
	...
	public static long stoichiometricCoeffInstanceId = System.nanoTime();
	...
	// Declared to serve as the id for instances of mechanism creators.
	public static long mechanismCreatorInstanceId = System.nanoTime();

	// Declared to serve as the id for instances of journals.
	public static long journalInstanceId = System.nanoTime();

	// Declared to serve as the id for instances of journal specifications.
	public static long journalSpecInstanceId = System.nanoTime();
	
	// Declared to serve as the id for instances of references.
	public static long referenceInstanceId = System.nanoTime();
	...
	// Maintains the map between the reactant label and reactant ID.
	public static HashMap<String, Long> reactantVsReactantIdMap;
	// Maintains the map between the product label and product ID.
	public static HashMap<String, Long> productVsProductIdMap;
	// Maintains the list of forward reaction order species.
	public static Set<String> forwardReactionOrderSpecies;
	// Maintains the list of revers reaction order species.
	public static Set<String> reverseReactionOrderSpecies;
	// Maintains the map between the product or reactant species label 
	// and reaction order.
	public static HashMap<String, Long> speciesLabelVsReactionOrderIdMap;
	...
	//================CompChem to OWL Place Holders Started====================================//
	public static CompChemOwlWriter compChemOwlWriter;
	public static CompChem compChem;
	public static OWLIndividual individual;
	//================CompChem to OWL Place Holders Ended====================================//
	
	//================OWL to CTML conversion: Bibliographic Reference Started================//
	public Creator creator = new Creator();
	public Journal journal = new Journal();
	public Reference reference = new Reference();
	public PublicationSpecification publicationSpec = new PublicationSpecification();
	public JournalSpecification journalSpec = new JournalSpecification();
	public List<Creator> creators = new ArrayList<>();
	public static List<Reference> references = new ArrayList<>();
	public static IDoiParser iDoiParser;
	public static IDoi iDoi;
	//================OWL to CTML conversion: Bibliographic Reference Ended================//
