...
import com.cmclinnovations.ontokin.model.configuration.OntoKinTBox;
...
public class TBoxManagement implements ITBoxManagement{
	...
	public OntoKinTBox ontoKinTBox;
	 ...
	 */
	public void createOWLClass(String className, String parentName) throws OntoException {
	...
	public void init() throws OntoException, OWLOntologyCreationException{
		...
		if (ontoKinTBox == null) {
			ontoKinTBox = applicationContext.getBean(OntoKinTBox.class);
		}
		if(ontologyIRI==null){
