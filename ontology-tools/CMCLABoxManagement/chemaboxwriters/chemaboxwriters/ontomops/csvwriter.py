...
def om_csvwriter(data):
    ...
    if "Mops_Molecular_Weight" in data:
    ...
    if "Mops_Symmetry_Point_Group" in data:
    ...
    if "Mops_Polyhedral_Shape_Symbol" in data:
    ...
    if "Mops_Chemical_Building_Units" in data: 
        for i in range(len(data["Mops_Chemical_Building_Units"])): #We will loop through all the building units in the JSON.
            ...
            if "CBU_Formula" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "BindingDirection" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "OntoSpecies_IRI" in data["Mops_Chemical_Building_Units"][i]:
                spamwriter.writerow([mops_pref + 'ChemicalBuildingUnit_' + gen_id + '_' + str(i), 'Instance',
                data["Mops_Chemical_Building_Units"][i]["OntoSpecies_IRI"],onto_spec + '#hasUniqueSpecies','','']) #Connect CBU to OntoSpecies entry.

            if "Binding_Site" in data["Mops_Chemical_Building_Units"][i]:
                ...
                if "Binding_Site_Label" in data["Mops_Chemical_Building_Units"][i]:
                ...
                if "Binding_SiteCoordNumber" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "CoreLabel" in data["Mops_Chemical_Building_Units"][i]:
                ...
                if "CoreSubstituentLabel" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "SpacerLabel" in data["Mops_Chemical_Building_Units"][i]:
                ...
                if "SpacerSubstituentLabel" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "GenericUnitPlanarity" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "GenericUnitModularity" in data["Mops_Chemical_Building_Units"][i]:
            ...
            if "GenericUnitNumber" in data["Mops_Chemical_Building_Units"][i]:
