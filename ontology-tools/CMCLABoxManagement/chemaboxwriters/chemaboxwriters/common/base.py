...
if __name__ == '__main__':
    ...
    re_pattern = re.compile(r'\w+?((\.\w+?)+?:\w+?|(:\w+?)?)$')

    fs_uploads = 'a'
    fs_uploads_match = re.match(re_pattern,fs_uploads)
    if fs_uploads_match:
        print(f"fs_uploads: {fs_uploads}")
    ...
    fs_uploads = 'HANDLER_1.11_HANDLER_2:11_subdir'
    fs_uploads_match = re.match(re_pattern,fs_uploads)
    if fs_uploads_match:
        print(f"fs_uploads: {fs_uploads}")

    fs_uploads = 'HANDLER_1.11_HANDLER_2.HANDLER_3.HANDLER_4:11_subdir'
    fs_uploads_match = re.match(re_pattern,fs_uploads)
    if fs_uploads_match:
        print(f"fs_uploads: {fs_uploads}")

    fs_uploads = 'HANDLER_1.11_HANDLER_2.HANDLER_3.HANDLER_4:11_subdir.11_subdir.11_subdir'
    fs_uploads_match = re.match(re_pattern,fs_uploads)
    if fs_uploads_match:
        print(f"fs_uploads: {fs_uploads}")
