 ...
 * a PrIMe experiment's commonProperties data and metadata from an in-memory temporary 
 * storage to pass them to the corresponding PrIMe to OWL conversion methods.
 * 
 * @author Feroz Farazi (msff2@cam.ac.uk)
 *
 */
public interface ICommonPropertiesWriter {
	static Logger logger = org.slf4j.LoggerFactory.getLogger(ICommonPropertiesWriter.class);
