 ...
 * a PrIMe experiment's dataPoint data and metadata from an in-memory temporary 
...
public interface IDataPointWriter {
	static Logger logger = org.slf4j.LoggerFactory.getLogger(IDataPointWriter.class);
