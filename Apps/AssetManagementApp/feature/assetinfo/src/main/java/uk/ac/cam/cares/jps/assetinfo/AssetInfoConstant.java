...
public class AssetInfoConstant {
    ...
    static public final String SERIAL_NUMBER = "Serial Number";
    static public final String MODEL_NUMBER = "Model Number";
    ...
    static public final String INVOICE_NUMBER = "Invoice Number";
    static public final String DELIVERY_ORDER_NUMBER = "Delivery Order Number";
}
