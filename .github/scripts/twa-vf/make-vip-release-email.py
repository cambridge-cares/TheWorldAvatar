...
# whenever a new version of the TWA Visualisation Framework (TWA-VF) is released
...
with open('./web/twa-vis-platform/resources/VERSION', 'r') as f:
    version = f.read()
print("Have read version file.")

# Read the top most section of the patch notes
notes = ""
with open('./web/twa-vis-platform/resources/CHANGELOG.md', 'r') as f:
    lines = f.readlines()
    section = 0
...
with open('./web/twa-vis-platform/resources/release.html', 'r') as f:
    template = f.read()
