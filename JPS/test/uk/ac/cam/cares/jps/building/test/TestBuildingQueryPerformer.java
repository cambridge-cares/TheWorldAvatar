...
public class TestBuildingQueryPerformer extends TestCase implements SparqlConstants {
	...
	public void testTheHagueFilterBdns() {
	...
	public void testTheHagueOneBuildingSimpleBuildingData() {
		...
		assertEquals(-55.955, (double) result.BldAngle.get(i), 0.01);
	...
	public void testOLDQuery1 () {
		...
		System.out.println(query);
		String result = performQuery(null, query);
		System.out.println("\n" + result);
	}
	
	public void testBerlinPlant() {
...
//				"LIMIT 25";
		...
		//new BuildingQueryPerformer().performQueryFilterBdns(BuildingQueryPerformer.BERLIN, 100, 390000., 5815000., 396000., 5826000.);
	...
	public void testTheHaguePlant() {
		// <http://www.theworldavatar.com/Building/10_buildings0.owl#BuildingGUID_E59B86F5-443F-49AE-BD94-BAB9AAAA278A> (denhaag but old iri)
		...
		//new BuildingQueryAgent().performQueryFilterBldEnvelope("x", 25, 79480., 454670., 85000., 460000.);
		new BuildingQueryPerformer().performQueryBuildingsFromRegion(BuildingQueryPerformer.THE_HAGUE_IRI, 100, 79000., 454000., 81000., 456000.);

		
		//String result = new BuildingQueryPerformer().performQueryFilterBdns(BuildingQueryPerformer.THE_HAGUE, 100, 79000., 454000., 79800., 455200.);
