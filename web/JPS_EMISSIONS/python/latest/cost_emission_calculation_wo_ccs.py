...
# without CCS in CCS scenario  

import numpy as np
from scipy import interpolate
from scipy.interpolate import LinearNDInterpolator

def  cost_emission_calculation_wo_ccs (m, n): 
    ...
    if m.shape[0] == 0:
       ...
       pass
        ...
        m = m.assign(wo_ccs_cost = cost)
        m = m.assign(wo_ccs_emission = emission)
        
        # m.rename(columns={'wo_ccs_cost': 'wo_ccs_cost_$_MWh', 'wo_ccs_emission': 'wo_ccs_annual_emission_ton'}, inplace=True)
        k = m.loc[:,:]
