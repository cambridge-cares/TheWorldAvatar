...
public class SimulationCoordination extends JPSHttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (reactList != null) {
			 AgentCaller.executeGetWithJsonParameter("JPS_BIODIESELPLANT3/DoSimulation", request.toString());
		}else {
			 AgentCaller.executeGetWithJsonParameter("JPS_BIODIESELPLANT3/DoSimulation2", request.toString());
		}
