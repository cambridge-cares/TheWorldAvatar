    ...
    public class RTS_Camera : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            if (Input.touchCount > 0 && Input.GetTouch(0).phase == TouchPhase.Moved)
            {
                ...
                m_Transform.Translate(-touchDeltaPosition.x * 10, -touchDeltaPosition.y * 10, 0);
            }
            ...
            if (Input.touchCount == 2)
            {
                ...
                {
                    GetComponent<Camera>().orthographicSize += deltaMagnitudeDiff * 10;
                    GetComponent<Camera>().orthographicSize = Mathf.Max(GetComponent<Camera>().orthographicSize, 0.1f);
                }
                else
                {
                    GetComponent<Camera>().fieldOfView += deltaMagnitudeDiff * 10;
        ...
        private void HeightCalculation()
        {
            ...
            if(useScrollwheelZooming && !Input.GetKey(KeyCode.LeftAlt))
        ...
        private void Rotation()
        {
            ...
            {
                if (Mathf.Abs(MouseAxis.x) >= Mathf.Abs(MouseAxis.y))
                {
            ...
            if (Input.touchCount > 2)
            {
                ...
                {
                    m_Transform.Rotate(Vector3.up, -touchDeltaPosition.x * Time.deltaTime * 5, Space.World);
                }
                else
                {
                    m_Transform.Rotate(Vector3.left, -touchDeltaPosition.y * Time.deltaTime * mouseRotationSpeed, Space.Self);
                }
