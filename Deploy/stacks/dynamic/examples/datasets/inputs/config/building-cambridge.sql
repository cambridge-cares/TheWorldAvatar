WITH "toid_table" AS (SELECT "strval" AS "toid", "cityobject_id" FROM "cityobject_genericattrib" WHERE "attrname"='os_topo_toid'),
...
SELECT "building_id","measured_height" AS "building_height","geometry","toid","uuid","iri" FROM
