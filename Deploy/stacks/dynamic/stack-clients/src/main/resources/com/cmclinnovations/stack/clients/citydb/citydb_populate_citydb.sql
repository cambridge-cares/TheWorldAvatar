...
SELECT "citydb"."cityobject"."id",
    26,
    "citydb"."cityobject"."id",
    "public"."raw_building"."mh",
    '#m'
FROM "citydb"."cityobject",
    "public"."raw_building"
WHERE "citydb"."cityobject"."gmlid" = "public"."raw_building"."gmlid";
INSERT INTO "citydb"."cityobject_genericattrib" ("attrname", "datatype", "strval", "cityobject_id")
SELECT '{IDname}',
    1,
    "public"."raw_building"."{IDval}",
    "citydb"."cityobject"."id"
FROM "citydb"."cityobject",
    "public"."raw_building"
WHERE "citydb"."cityobject"."gmlid" = "public"."raw_building"."gmlid";
...
INSERT INTO "citydb"."surface_geometry" (
        ...
        SELECT "co"."gmlid" || '_child',
            ...
            0,
            0,
            "public"."raw_surface"."geom",
            "sgp"."coid"
        FROM "sgp",
            "public"."raw_surface",
            "co"
        WHERE "public"."raw_surface"."gmlid" = "co"."gmlid"
...
INSERT INTO "citydb"."thematic_surface" (
        ...
        FROM (
                SELECT "citydb"."cityobject"."id" AS "coid",
            ...
            (
                SELECT "citydb"."cityobject"."id",
                    ...
                    "public"."raw_surface"."building_gmlid" AS "building_gmlid",
                    "citydb"."surface_geometry"."id" AS "lod2_multi_surface_id"
                FROM "citydb"."cityobject",
                    "public"."raw_surface",
                    "citydb"."surface_geometry"
                WHERE "citydb"."cityobject"."gmlid" = "public"."raw_surface"."gmlid"
