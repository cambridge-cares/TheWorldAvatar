...
CREATE TABLE "public"."building_without_footprint_CityDB" AS (
    ...
    WHERE
        "building"."lod0_footprint_id" IS NULL
);
...
CREATE TABLE "public"."footprint_soup_CityDB" AS (
            ...
            FROM
                (
                    SELECT
                        ...
                        "zmin"
                    FROM
                        "building_without_footprint_CityDB"
    ...
    WHERE
        public.GeometryType("geometry") = 'POLYGON'
);
...
WITH "fp_parent" AS (
    INSERT INTO
        "citydb"."surface_geometry" (
            ...
            SELECT
                "building_without_footprint_CityDB"."gmlid" || '_footprint',
                0,
                0,
                0,
                0,
...
"anon" AS (
    UPDATE
        "citydb"."building"
    SET
        "lod0_footprint_id" = "fp_parent"."footprint_id"
    FROM
        "fp_parent"
    WHERE
        "building"."id" = "fp_parent"."bid"
        AND "building"."lod0_footprint_id" IS NULL RETURNING "id",
        "lod0_footprint_id"
)
INSERT INTO
    "citydb"."surface_geometry" (
        ...
        SELECT
            "footprint_soup_CityDB"."gmlid" || '_footprint_child',
