...
| Example                                                                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [bavaria](../examples/datasets/inputs/config/bavaria.json)                   | Uploads a [set of CityGML files](../examples/datasets/inputs/data/bavaria/README.md) into the Postgres database of the stack. [b3dm files] are generated automatically with default settings for visualisation. There is also a OBDA mapping file ([ontop_with_comments.obda](../examples/datasets/inputs/data/bavaria/citydbOntop.obda)), which provides an example of how to make the uploaded data queryable through the Ontop SPARQL endpoint.                                                                                                                                                                                                                                                                                                      |
