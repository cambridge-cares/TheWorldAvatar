...
Example dataset files can be found in the [`examples/stack-data-uploader`](../examples/stack-data-uploader/) directory.
...
There are several example configuration files in the [`examples/stack-data-uploader`](../examples/stack-data-uploader/) directory.
You can follow the instructions in the [README.md](../examples/stack-data-uploader/README.md) to load in one of the example datasets.
The following table provides a description of each example:

| Example                                                                      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ---------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [cropmap-reduced](../examples/stack-data-uploader/inputs/config/cropmap-reduced.json)   | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/cropmap/vector/README.md) into the stack as single vector layer, which is served using the default style by GeoServer. This is a reduced styling ([cropmap-reduced.sld](../examples/stack-data-uploader/inputs/config/cropmap-reduced.sld)) of the cropmap to make it clearer to view with pylon data.                                                                                                                                                                                                                                                                                                                                                                                              |
| [cropmap-simple](../examples/stack-data-uploader/inputs/config/cropmap-simple.json)     | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/cropmap/vector/README.md) into the stack as single vector layer, which is served using the default style by GeoServer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [cropmap](../examples/stack-data-uploader/inputs/config/cropmap.json)                   | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/cropmap/vector/README.md) into the stack as single vector layer along with several [.csv files](../examples/stack-data-uploader/inputs/data/cropmap/tabular/) that contain auxiliary data. Some of the auxiliary data is then used by a custom style ([cropmap.sld](../examples/stack-data-uploader/inputs/config/cropmap.sld)) to dynamically colour the polygons when served through GeoServer. There is also a OBDA mapping file ([ontop_with_comments.obda](../examples/stack-data-uploader/inputs/data/cropmap/ontop_with_comments.obda)), which provides an example of how to make the uploaded data queryable through the Ontop SPARQL endpoint. Uses [reference to file name](#value-by-file-name) for SQL query. |
| [elevation](../examples/stack-data-uploader/inputs/config/elevation.json)               | Uploads a set of [GeoTiff files](../examples/stack-data-uploader/inputs/data/elevation/README.md) into the stack as a single raster layer, which is served using the built in `dem` style via GeoServer. The custom style ([elevation.sld](../examples/stack-data-uploader/inputs/config/elevation.sld)) is also provided for reference.                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| [forestry](../examples/stack-data-uploader/inputs/config/forestry.json)                 | Uploads [a ShapeFile](../examples/stack-data-uploader/inputs/data/forestry/vector/README.md) into the stack as a vector layer, along with a [.csv file](../examples/stack-data-uploader/inputs/data/forestry/tabular/forestry_colours.csv) that defines a colour for each category. The layer is served using the colour mapping and a custom style ([forestry.sld](../examples/stack-data-uploader/inputs/config/forestry.sld)) through GeoServer.                                                                                                                                                                                                                                                                                                                                      |
| [forestry-reduced](../examples/stack-data-uploader/inputs/config/forestry-reduced.json) | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/forestry/vector/README.md) into the stack as single vector layer, which is served using the default style by GeoServer. This is a reduced styling ([forestry-reduced.sld](../examples/stack-data-uploader/inputs/config/forestry-reduced.sld)) of the forestry data to make it clearer to view with pylon data.                                                                                                                                                                                                                                                                                                                                                                                     |
| [ng-pylons](../examples/stack-data-uploader/inputs/config/ng-pylons.json)               | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/ng_pylons/vector/) into the stack as multiple vector layers along a [.csv file](../examples/stack-data-uploader/inputs/data/ng_pylons/tabular/ng_styling.csv) that contain auxiliary data. Some of the auxiliary data is then used by custom styles ([overhead-lines.sld](../examples/stack-data-uploader/inputs/config/overhead-lines.sld) and [underground-cables.sld](../examples/stack-data-uploader/inputs/config/underground-cables.sld)) to dynamically style the lines, towers, and underground cables when served through GeoServer.                                                                                                                                                                             |
| [population](../examples/stack-data-uploader/inputs/config/population.json)             | Uploads [a GeoTiff file](../examples/stack-data-uploader/inputs/data/population/README.md) into the stack as a raster layer, which is served using the default style via GeoServer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| [pylons](../examples/stack-data-uploader/inputs/config/pylons.json)                     | An example of how to use the `"externalDatasets"` node to load multiple datasets by name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [pylons-and-veg](../examples/stack-data-uploader/inputs/config/pylons-and-veg.json)     | An example of how to use the `"externalDatasets"` node to load multiple datasets by name of another config referencing other `"externalDatasets".                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
| [treesAndHills](../examples/stack-data-uploader/inputs/config/treesAndHills.json)       | An example of how to use the `"externalDatasets"` node to load multiple datasets by name.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [ukpn-pylons](../examples/stack-data-uploader/inputs/config/ukpn-pylons.json)           | Uploads a [set of Shapefiles](../examples/stack-data-uploader/inputs/data/ukpn_pylons/vector/) into the stack as multiple vector layers along with a [.csv file](../examples/stack-data-uploader/inputs/data/ukpn_pylons/tabular/ukpn_styling.csv) that contain auxiliary data. Some of the auxiliary data is then used by a custom style ([overhead-lines.sld](../examples/stack-data-uploader/inputs/config/overhead-lines.sld) to dynamically style the lines and towers when served through GeoServer. There is also a OBDA mapping file ([ukpn_ontop.obda](../examples/stack-data-uploader/inputs/data/ukpn_pylons/ukpn_ontop.obda)), which provides an example of how to make the uploaded data queryable through the Ontop SPARQL endpoint.                                                  |
| [rdf](../examples/stack-data-uploader/inputs/config/rdf.json)                           | A wrapper around a collection of examples of loading in [RDF](#rdf-data) data. This includes triples [with](../examples/stack-data-uploader/inputs/config/triples_with_inference.json) and [without](../examples/stack-data-uploader/inputs/config/triples.json) inference; [quads](../examples/stack-data-uploader/inputs/config/quads.json); and [using a properties file](../examples/stack-data-uploader/inputs/config/triples_using_properties_file.json).                                                                                                                                                                                                                                                                                                                                     |
| [tboxcsv](../examples/stack-data-uploader/inputs/config/tboxcsv.json)                   | An example of loading a TBox from a CSV file into a custom Blazegraph namespace.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
The OBDA file for the cropmap example ([ontop_with_comments.obda](../examples/stack-data-uploader/inputs/data/cropmap/ontop_with_comments.obda)) shows the Ontop OBDA format.
...
The [cropmap](../examples/stack-data-uploader/inputs/data/cropmap/ontop_with_comments.obda) example OBDA file shows how to use the PostGIS function [`ST_ASTEXT`](https://postgis.net/docs/ST_AsText.html) and the [`http://www.opengis.net/ont/geosparql#wktLiteral`](http://www.opengis.net/ont/geosparql#wktLiteral) to make it possible to run GeoSPARQL queries.
...
- To upload only specific properties/fields from a source dataset their names can be specified as comma-separated values for the [`"-select"`][ogr2ogr-select] option under [`"otherOption"`](#otheroptions).
    ...
    ```
    The [cropmap](../examples/stack-data-uploader/inputs/config/cropmap.json) example shows this being used to remove some fields (containing calculated areas and perimeters) that were not constantly named across all of the [crop-map-of-england-crome-2020][crome-2020] Shapefiles.
