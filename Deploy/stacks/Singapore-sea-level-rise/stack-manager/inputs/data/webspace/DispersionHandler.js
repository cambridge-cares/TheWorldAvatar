class DispersionHandler {
    ...
    plotData() {
        MapHandler.MAP.setFilter('0.10.dispersion-layer', ["all",
        ...
        MapHandler.MAP.setFilter('0.10.ships-layer', ["all",
            ['==', ['string', ['get', 'derivation']], this.dispersions[this.selectedSimulation].derivationIri],
            ['==', ['to-number', ['get', 'time']], this.selectedTimestep]
        ]);

        MapHandler.MAP.setFilter('0.10.weather-layer', ["all",
            ['==', ['string', ['get', 'derivation']], this.dispersions[this.selectedSimulation].derivationIri]
        ]);
    ...
    addColourBar() {
        ...
        if (document.getElementById("dispersion-colorbar-container") != null) {
            colourBarElement = document.getElementById("dispersion-colorbar-container");
        } else {
