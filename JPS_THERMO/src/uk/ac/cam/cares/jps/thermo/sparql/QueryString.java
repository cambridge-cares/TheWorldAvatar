...
public class QueryString {
	 ...
	 * 
	 * @param uuid
	 * @return String that is a sparql query that contains given uuid as input parameter.
	 */
	synchronized public static String getAllTriplesForThermoCalculation(String uuid) {
