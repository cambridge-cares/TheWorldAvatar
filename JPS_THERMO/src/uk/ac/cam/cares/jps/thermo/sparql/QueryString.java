...
public class QueryString {
	...
	public static String getAllTriplesForThermoCalculation(String uuid) {
		...
		String query="PREFIX compchemkb: <https://como.cheng.cam.ac.uk/kb/compchem.owl#>"
				...
				+ "WHERE {"
				+ "{"
				+ "?g09 compchemkb:hasInitialization ?s0 ."
				+ "?s0 gc:hasMoleculeProperty ?s1 ."
				+ "?s1 gc:hasName ?moleculeName . "
				+ "}"
				+ "UNION"
				+ "{"
				+ "?g09 compchemkb:hasInitialization ?s2 ."
				+ "?s2 gc:hasMoleculeProperty ?s3 ."
				+ "?s3 gc:hasMolecule ?s4 ."
				+ "?s4 gc:hasNumberOfAtoms ?atomNumber ."
				+ "?s4 gc:hasAtom ?s5 ."
				+ "?s5 gc:isElement ?atomName ."
				+ "}"
				+ "UNION"
				+ "{"
	...
	public static String getAllTriplesForThermoCalculation(String uuid) {
		...
		String query="PREFIX compchemkb: <https://como.cheng.cam.ac.uk/kb/compchem.owl#>"
				...
				+ "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>"
				+ "PREFIX rdf:<http://www.w3.org/1999/02/22-rdf-syntax-ns#>"
				+ "SELECT ?moleculeName ?atomName ?atomNumber ?levelOfTheory ?basisSetValue ?frequenciesSize ?frequenciesValue ?frequenciesUnit ?spinMultiplicityValue  ?coordinateX ?coordinateY ?coordinateZ ?massValue ?massUnit ?geometryTypeValue ?rotationalConstantsSize ?rotationalConstantsUnit ?rotationalConstantsValue ?rotationalSymmetryNumber ?programName ?programVersion ?runDate"
				+ "WHERE {"
				+ "{"
				+  "<"+uuid+"> compchemkb:hasInitialization ?mn0 ."
				+ "?mn0 gc:hasMoleculeProperty ?mp0 ."
				+ "?mp0 gc:hasName ?moleculeName ."
				+ "}"
				+ "UNION"
				+ "{"
				+  "<"+uuid+"> compchemkb:hasInitialization ?mn1 ."
				...
				+ "UNION"
				+ "{"
				+ "<"+uuid+"> compchemkb:hasInitialization ?mn2 ."
				+ "?mn2 gc:hasParameter ?p1 ."
				+ "?p1 rdf:type <https://como.cheng.cam.ac.uk/kb/compchem.owl#LevelOfTheory> ."
				+ "?p1 compchemkb:hasLevelOfTheory ?levelOfTheory ."
				+ "?mn2 gc:hasParameter ?p2 ."
				...
				+ "UNION"
				+ "{"
				+ "<"+uuid+"> compchemkb:hasEnvironment ?env ."
				+ "?env compchemkb:hasProgram ?programName ."
				+ "?env compchemkb:hasProgramVersion ?programVersion ."
				+ "?env compchemkb:hasRunDate ?runDate ."
				+ "}"
