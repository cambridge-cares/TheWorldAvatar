package uk.ac.cam.cares.jps.electricalnetwork;
...
import uk.ac.cam.cares.jps.visualization.ENVisualization;
import uk.ac.cam.cares.jps.visualization.ENVisualization.StaticobjectgenClass;
import uk.ac.cam.cares.jps.visualization.IriMapper;
import uk.ac.cam.cares.jps.visualization.IriMapper.IriMapping;
import uk.ac.cam.cares.jps.visualization.MapPoint;
...
//		}
	...
	public void startSimulation(String iriofnetwork, String baseUrl, String modeltype) throws IOException {
		...
		try {
			logger.info("converting Final results to OWL files");
	...
	public List<String[]> generateInput(OntModel model, String iriofnetwork, String baseUrl, String modeltype) throws IOException {
		...
		String resourceDir = AgentLocator.getCurrentJpsAppDirectory(this) + "/res";
		File file = new File(resourceDir + "/baseMVA.txt");
		broker.put(baseUrl + "/baseMVA.txt", file);

		File file2 = new File(AgentLocator.getNewPathToPythonScript("model", this) + "/Final.py");
		broker.put(baseUrl + "/Final.py", file2);
