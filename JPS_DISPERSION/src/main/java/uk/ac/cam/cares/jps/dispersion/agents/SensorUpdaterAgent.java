...
public class SensorUpdaterAgent extends JPSAgent{
    ...
    public JSONObject processRequestParameters(JSONObject requestParams) {
        ...
        if (validateInput(requestParams)) {
        	...
        	double [] xy = ss.queryAirStationCoordinatesWithIRI(stationiri);
        	...
        	String interp_result = AgentCaller.executeGetWithJsonParameter("JPS_DISPERSION/InterpolationPyAgent", request.toString());
        	...
        	while (it.hasNext()) {
        		...
        		if (HCs.contains(component)) {
        			...
        			ss.addSensorValue(stationiri, dataname, conc, true);
        			concNOx += conc;
        	...
        	ss.addSensorValue(stationiri, SensorSparql.HC, concHC, true);
        	ss.addSensorValue(stationiri, SensorSparql.NOx, concNOx, true);
        }
        return responseParams;
    }
