...
public class TimeSeriesRDBClientIntegrationTest {
	...
	public static void connect() throws SQLException, ClassNotFoundException {
		...
		// Connect to DB and clear database
	...
	@Deprecated
	public void deprecatedInitialiseRDBClient() {
		// Set up TimeSeriesRDBClient to interact with RDB (PostgreSQL)
		// One must specify the class of the time values, these tests uses the Instant class
		// One can use classes such as LocalDateTime, Timestamp, Integer, Double, etc.
		// Once you initialise it with a certain class, you should stick to it
	...
	@Deprecated
	public void deprecatedTestInitCentralTable() throws NoSuchFieldException, IllegalAccessException {
		// Retrieve the value of the private field 'dbTableName' of the client to check its value
		Field tableNameField = client.getClass().getDeclaredField("dbTableName");
		tableNameField.setAccessible(true);
		String tableName = (String) tableNameField.get(client);
	...
	@Deprecated
	public void deprecatedTestInitExceptions() {
		// Check exception for wrong dataClass size
		try {
	...
	@Deprecated
	public void deprecatedTestInitTimeSeriesTable() throws NoSuchFieldException, IllegalAccessException {
		// Initialise 1st time series
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Check that timeseries table was created in addition to central table
		Assert.assertEquals(2, context.meta().getTables().size());
	...
	@Deprecated
	public void deprecatedTestAddTimeseriesData() throws NoSuchFieldException, IllegalAccessException {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
	...
	@Deprecated
	public void deprecatedTestAddTimeseriesDataExceptions() {
		try {
			// Add time series data for non-initialised time series and central table
			client.addTimeSeriesData(ts_list1);
		} catch (JPSRuntimeException e) {
	...
	@Deprecated
	public void deprecatedTestGetTimeseries() {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestGetTimeseriesExceptions() {
		try {
			// Get time series data for non-initialised time series and central table
	...
	@Deprecated
	public void deprecatedTestGetTimeseriesWithinBounds() throws NoSuchFieldException, IllegalAccessException {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestGetAggregates() {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestGetMinMaxTimes() {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestDeleteRows() {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestDeleteTimeSeries() throws NoSuchFieldException, IllegalAccessException {
		// Initialise time series table
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		// Add time series data
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestDeleteTimeSeriesTable() throws NoSuchFieldException, IllegalAccessException {
		// Initialise time series tables
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		client.initTimeSeriesTable(dataIRI_3, dataClass_3, tsIRI_3);
		// Add time series data
	...
	@Deprecated
	public void deprecatedTestDeleteAll() {
		// Initialise time series tables
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		client.initTimeSeriesTable(dataIRI_3, dataClass_3, tsIRI_3);
		// Add time series data
	...
	@Deprecated
	public void deprecatedTestGetLatestData() {
		// Initialise time series tables
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		client.addTimeSeriesData(ts_list1);
	...
	@Deprecated
	public void deprecatedTestGetOldestData() {
		// Initialise time series tables
		client.initTimeSeriesTable(dataIRI_1, dataClass_1, tsIRI_1);
		client.addTimeSeriesData(ts_list1);
