...
public class RemoteStoreClientTest {
	...
	public void testGet() {
		...
		String actual = "<rdf:RDF" + System.getProperty("line.separator") +
	...
	private static String formInsertQuery() {
		...
		query = query.concat("PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n");
		query = query.concat(
				"INSERT DATA { <http://www.theworldavatar.com/kb/ontokin/POLIMI_H2CO_1412.owl#ArrheniusCoefficient_182161099217501> ontokin:hasTemperatureExponent \"-0.7\" }");
		return query;
	}
	...
	private static String formTempExponentQuery() {
		...
		query = query.concat("{\n");
		query = query.concat(
				"<http://www.theworldavatar.com/kb/ontokin/POLIMI_H2CO_1412.owl#ArrheniusCoefficient_182161099217501> ontokin:hasTemperatureExponent ?tempExponent .\n");
		query = query.concat("}");
		return query;
	}
	...
	private static String formDeleteQuery() {
		...
		query = query.concat("PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#>\n");
		query = query.concat(
				"DELETE DATA { <http://www.theworldavatar.com/kb/ontokin/POLIMI_H2CO_1412.owl#ArrheniusCoefficient_182161099217501> ontokin:hasTemperatureExponent \"-0.7\" }");
		return query;
	}
	...
	public static void main(String[] args) {
		...
		List<String> endpoints = new ArrayList<>(fii.getEndpoints());
