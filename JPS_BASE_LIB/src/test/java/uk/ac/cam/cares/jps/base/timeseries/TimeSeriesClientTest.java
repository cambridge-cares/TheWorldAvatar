...
//        Assert.assertEquals("postgres", rdbClient.getRdbUser());
    ...
    @Deprecated
    public void deprecatedSetUpClient() throws URISyntaxException, IOException {
    ...
    @Deprecated
    public void deprecatedTestConstructorWithKBClientAndRdbProperties() throws IOException, NoSuchFieldException, IllegalAccessException, URISyntaxException {
        RemoteStoreClient kbClient = new RemoteStoreClient();
        kbClient.setQueryEndpoint("sparql_query");
        kbClient.setUpdateEndpoint("sparql_update");
    ...
    @Deprecated
    public void deprecatedTestConstructorWithKBClient() throws IOException, NoSuchFieldException, IllegalAccessException, URISyntaxException {
        RemoteStoreClient kbClient = new RemoteStoreClient();
        kbClient.setQueryEndpoint("sparql_query");
        kbClient.setUpdateEndpoint("sparql_update");
        TimeSeriesClient<Instant> client = new TimeSeriesClient<>(kbClient, Instant.class,
    ...
    @Deprecated
    public void deprecatedTestConstructorWithOnlyPropertiesFile() throws NoSuchFieldException, IllegalAccessException {
        // Retrieve the rdf client to test whether it is set correctly
        Field rdfClientField = TimeSeriesClient.class.getDeclaredField("rdfClient");
        rdfClientField.setAccessible(true);
        TimeSeriesSparql rdfClient = (TimeSeriesSparql) rdfClientField.get(testClient);
    ...
    @Deprecated
    public void deprecatedTestSetKBClient() throws NoSuchFieldException, IllegalAccessException {
        RemoteStoreClient kbClient = new RemoteStoreClient();
        kbClient.setQueryEndpoint("sparql_query");
        kbClient.setUpdateEndpoint("sparql_update");
        testClient.setKBClient(kbClient);
    ...
    @Deprecated
    public void deprecatedTestSetRDBClient() throws NoSuchFieldException, IllegalAccessException {
    ...
    @Deprecated
    public void deprecatedTestInitTimeSeriesExceptionAfterStep1() throws NoSuchFieldException, IllegalAccessException {
        // Set-up stubbing
        Mockito.doThrow(new JPSRuntimeException("KG down")).when(mockSparqlClient).
                initTS(Mockito.anyString(), Mockito.anyList(), Mockito.anyString(), Mockito.anyString());
        setRDFMock();
    ...
    @Deprecated
    public void deprecatedTestInitTimeSeriesExceptionAfterStep2() throws NoSuchFieldException, IllegalAccessException {
        // KG reversion works //
        // Set-up stubbing
        Mockito.doNothing().when(mockSparqlClient).
                initTS(Mockito.anyString(), Mockito.anyList(), Mockito.anyString(), Mockito.anyString());
    ...
    @Deprecated
    public void deprecatedTestDeleteIndividualTimeSeriesNoTSIRI() throws NoSuchFieldException, IllegalAccessException {
        // Set-up stubbing
        Mockito.when(mockSparqlClient.getTimeSeries(dataIRIs.get(0))).thenReturn(null);
        setRDFMock();
        try {
    ...
    @Deprecated
    public void deprecatedTestDeleteIndividualTimeSeriesExceptionAfterStep1() throws NoSuchFieldException, IllegalAccessException {
        String dataIRI = dataIRIs.get(0);
        // Set-up stubbing
        Mockito.when(mockSparqlClient.getTimeSeries(dataIRI)).thenReturn("tsIRI");
        Mockito.when(mockSparqlClient.getAssociatedData(dataIRI).size()).thenReturn(2);
    ...
    @Deprecated
    public void deprecatedTestDeleteIndividualTimeSeriesExceptionAfterStep2() throws NoSuchFieldException, IllegalAccessException {
        String dataIRI = dataIRIs.get(0);
        // KG reversion works //
        // Set-up stubbing
        Mockito.when(mockSparqlClient.getTimeSeries(dataIRI)).thenReturn("tsIRI");
    ...
    @Deprecated
    public void deprecatedTestDeleteTimeSeriesNoTSIRI() throws NoSuchFieldException, IllegalAccessException {
        String tsIRI = "tsIRI";
        // Set-up stubbing
        Mockito.when(mockSparqlClient.checkTimeSeriesExists(tsIRI)).thenReturn(false);
        setRDFMock();
    ...
    @Deprecated
    public void deprecatedTestDeleteTimeSeriesExceptionAfterStep1() throws NoSuchFieldException, IllegalAccessException {
        String tsIRI = "tsIRI";
        // Set-up stubbing
        Mockito.when(mockSparqlClient.checkTimeSeriesExists(tsIRI)).thenReturn(true);
        Mockito.when(mockSparqlClient.getAssociatedData(tsIRI)).thenReturn(dataIRIs);
    ...
    @Deprecated
    public void deprecatedTestDeleteTimeSeriesExceptionAfterStep2() throws NoSuchFieldException, IllegalAccessException {
        String tsIRI = "tsIRI";
        // KG reversion works //
        // Set-up stubbing
        Mockito.when(mockSparqlClient.checkTimeSeriesExists(tsIRI)).thenReturn(true);
    ...
    @Deprecated
    public void deprecatedTestDeleteAllException() throws NoSuchFieldException, IllegalAccessException {
        // KG Exception //
        // Set-up stubbing
        Mockito.doThrow(new JPSRuntimeException("KG down")).when(mockSparqlClient).removeAllTimeSeries();
        setRDFMock();
    ...
    @Deprecated
    public void deprecatedTestAddTimeSeriesException()  throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetTimeSeriesWithinBoundsException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetTimeSeriesException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetAverageException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetMaxValueException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetMinValueException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetMaxTimeException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestGetMinTimeException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
    ...
    @Deprecated
    public void deprecatedTestDeleteTimeSeriesHistoryException() throws NoSuchFieldException, IllegalAccessException {
        // Only tests for the first Exception to occur when called without prior initialised time series
