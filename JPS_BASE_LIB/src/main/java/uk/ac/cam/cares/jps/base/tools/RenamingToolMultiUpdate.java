...
public class RenamingToolMultiUpdate {
...
//********************************************
	...
	public void perform(KnowledgeBaseClient kbClient) throws ParseException {
	
		//count query
		String graph = null;
		String query = countQuery(graph);
		...
		for(int offset = 0; offset<steps; offset++) {
			 sparqlUpdate = buildSparqlUpdateString(graph, 0, stepSize); //offset*stepSize
	    ...
	    if (count > 0) {
			sparqlUpdate = buildSparqlUpdateString(graph, 0, 0);
			kbClient.executeUpdate(sparqlUpdate);
	    }
...
//********************************************
	...
	*/
	 ...
	 * */
	public RenamingToolMultiUpdate(String strTarget, String strReplacement) {
	 ...
	 * @param strReplacement 	replacement string or uri
	 * */
	public RenamingToolMultiUpdate(String strMatch, String strTarget, String strReplacement) {
	...
	*/
	 ...
	 * @throws ParseException
	 */
	private UpdateRequest buildSparqlUpdateString(String graph, int offset, int splits) throws ParseException {
