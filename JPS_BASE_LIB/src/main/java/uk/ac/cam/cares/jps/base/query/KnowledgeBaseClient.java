...
public class KnowledgeBaseClient {
    ...
    /**
     * Performs a SPARQL update on the resource identified by its target url (if this possible). If
     * a scenario url is given in the JPS context, then the SPARQL update is redirected to the
     * scenario url.
     *
     * @param targetUrl
     * @param sparqlUpdate
...
//		requestUrl = ResourcePathConverter.convertToLocalPath(requestUrl);
    ...
    /**
     * Apache HTTP client applies percentage encoding to any URL. Usually, this is not a problem
     * when requesting an OWL file. But if requesting
     * http://www.theworldavatar.com/kb/agents/Service__OpenWeatherMap.owl#Service then percentage
     * encoding results into
     * http://www.theworldavatar.com/kb/agents/Service__OpenWeatherMap.owl%23Service and a
     * consecutive Tomcat error. To avoid %23 instead of #, we simply skip the #-part by applying
     * this methode to the requested Url.
     *
     * @return
     */
