...
//		urlOrPath = ResourcePathConverter.convert(urlOrPath);
    ...
    public void putOld(String destinationUrl, String content) {
        ...
        //LOGGER.info("put for destinationUrl=" + destinationUrl + ", scenarioUrl=" + scenarioUrl);
        // TODO-AE SC 20190416 this is just a hack to read local file, refactor this method
     ...
     * <br>
     * https://github.com/apache/jena/blob/master/jena-rdfconnection/src/main/java/org/apache/jena/rdfconnection/examples/RDFConnectionExample1.java
     *  <br>
     ...
     * https://jena.apache.org/documentation/javadoc/arq/org/apache/jena/update/UpdateExecutionFactory.html
     *  <br>
