...
def create_directory(script_dir, folder_name):
    ...
    dir_list                        = [synText, input_dir_pdf, input_dir_txt, input_dir_cbu, input_dir_preSteps, input_dir_steps, input_dir_extractedProcedure, input_dir_chemicals1, input_dir_characterisation]
